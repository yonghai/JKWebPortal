...
Source Database       : jike1

Target Server Type    : MYSQL
Target Server Version : 50173
File Encoding         : 65001

Date: 2014-12-25 12:59:24
*/
...
CREATE TABLE `addetail` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=27 DEFAULT CHARSET=utf8 COMMENT='广告躯体详情';

-- ----------------------------
-- Records of addetail
-- ----------------------------
INSERT INTO `addetail` VALUES ('11', '2', '1030996', null, '60');
INSERT INTO `addetail` VALUES ('13', '2', '1030997', null, '2.5');
...
CREATE TABLE `advertise` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='推荐的广告栏';

-- ----------------------------
-- Records of advertise
-- ----------------------------
INSERT INTO `advertise` VALUES ('1', '3', '1', '2014-12-25 10:38:32', 'http://the-advertisement-picture.qiniudn.com/main3.png', '即客送豪礼');
INSERT INTO `advertise` VALUES ('2', '0', '2', '2014-12-25 10:38:34', 'http://the-advertisement-picture.qiniudn.com/left_big3.png', '即客促销');
INSERT INTO `advertise` VALUES ('3', '2', '3', '2014-12-25 10:38:38', 'http://the-advertisement-picture.qiniudn.com/right_top3.png', '即客好礼');
INSERT INTO `advertise` VALUES ('4', '2', '4', '2014-12-25 10:38:44', 'http://the-advertisement-picture.qiniudn.com/right_bottom3.png', '即客帮手');
...
CREATE TABLE `allorder` (
  ...
  `billstatus` int(2) NOT NULL,
  `userid` int(11) NOT NULL,
  `ordertype` int(2) NOT NULL,
...
-- Records of allorder
-- ----------------------------
INSERT INTO `allorder` VALUES ('1', '1418029218721000', '0', '106', '0', '2014-12-10 16:35:54');
INSERT INTO `allorder` VALUES ('2', '1418029218824002', '1', '106', '0', '2014-12-10 16:40:47');
...
CREATE TABLE `bill` (
  ...
  `delivery_address_id` int(11) DEFAULT '0' COMMENT '送货地址',
  `delivery_address_stamp` int(11) DEFAULT '0' COMMENT '配送地址版本',
  `pay_status` int(11) DEFAULT '0' COMMENT '支付状态0=未支付1=已支付',
  `pay_type` int(11) DEFAULT NULL COMMENT '支付类型',
  `actual_pay_type` int(11) DEFAULT '0' COMMENT '实际支付类型',
  `reserved_delivery_time` varchar(20) DEFAULT NULL COMMENT '预约送货时间',
  `actual_delivery_time` varchar(11) DEFAULT NULL COMMENT '实际送货时间',
  `bill_status` int(11) DEFAULT '0' COMMENT '订单状态(0代表未处理状态，1代表正在处理状态)唯一)2代表已完成订单3代表取消的订单',
  `total_price` varchar(10) DEFAULT NULL COMMENT '总价',
  `delivery_id` int(11) DEFAULT '0' COMMENT '配送员',
  `createtime` timestamp NULL DEFAULT NULL COMMENT '下单时间',
  `lastupdatetime` timestamp NULL DEFAULT NULL,
  `isview` int(11) NOT NULL DEFAULT '0' COMMENT '0允许查看，1不允许查看(删除操作)',
  `orderid` varchar(45) NOT NULL COMMENT '订单id',
  `checkcode` varchar(45) NOT NULL COMMENT '验证码',
  `goodsnum` int(10) unsigned NOT NULL DEFAULT '0',
  `tel` varchar(45) NOT NULL COMMENT '收货人号码',
  `name` varchar(45) NOT NULL COMMENT '收货人姓名',
  `address` varchar(200) NOT NULL COMMENT '收货人地址',
  `isshow` int(11) DEFAULT '0' COMMENT '1=该订单被接，不显示出来',
  `deliveryprice` varchar(255) NOT NULL DEFAULT '0' COMMENT '配送费用',
  PRIMARY KEY (`id`),
  UNIQUE KEY `orderid` (`orderid`)
) ENGINE=InnoDB AUTO_INCREMENT=544 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='订单表';

-- ----------------------------
-- Records of bill
-- ----------------------------
INSERT INTO `bill` VALUES ('447', '70', '181', null, null, '0', null, null, null, '3', '51.5', '0', '2014-11-24 16:28:54', null, '0', '1416817734339000', '3012', '11', '17701361266', '王先生', '北京市昌平区天通苑天通东苑一区16号楼201室', '0', '0');
INSERT INTO `bill` VALUES ('448', '77', '189', null, null, '0', null, null, null, '3', '80.8', '9', '2014-11-25 12:37:39', null, '0', '1416890259630000', '0113', '7', '18611192295', '胡健', '北京市昌平区天通苑天通东苑一区56号楼1103', '0', '0');
INSERT INTO `bill` VALUES ('449', '69', '178', null, null, '0', null, null, null, '2', '12.7', '9', '2014-11-28 02:06:16', null, '0', '1417111576814000', '7478', '2', '15201351249', '王振江', '北京市昌平区天通苑天通东苑一区测试，请勿取消订单', '0', '0');
INSERT INTO `bill` VALUES ('450', '69', '184', null, null, '0', null, null, null, '3', '12.7', '0', '2014-11-28 02:11:53', null, '0', '1417111913781000', '3001', '2', '15211111111', '王振江', '北京市昌平区天通苑天通东苑三区白杨', '0', '0');
INSERT INTO `bill` VALUES ('451', '69', '178', null, null, '0', null, null, null, '3', '20.4', '9', '2014-11-28 02:16:35', null, '0', '1417112195112001', '8613', '4', '15201351249', '王振江', '北京市昌平区天通苑天通东苑一区测试，请勿取消订单', '0', '0');
INSERT INTO `bill` VALUES ('452', '69', '178', null, null, '0', null, null, null, '3', '191.6', '0', '2014-11-28 03:46:56', null, '0', '1417117616896002', '7603', '11', '15201351249', '王振江', '北京市昌平区天通苑天通东苑一区测试，请勿取消订单', '0', '0');
INSERT INTO `bill` VALUES ('453', '82', '192', null, null, '0', null, null, null, '3', '11.0', '0', '2014-11-28 03:50:40', null, '0', '1417117840666003', '3842', '2', '15201351249', '哈哈', '北京市昌平区天通苑天通东苑一区哈哈', '0', '0');
INSERT INTO `bill` VALUES ('454', '82', '192', null, null, '0', null, null, null, '3', '14.0', '0', '2014-11-28 03:54:00', null, '0', '1417118040065004', '3134', '7', '15201351249', '哈哈', '北京市昌平区天通苑天通东苑一区哈哈', '0', '0');
INSERT INTO `bill` VALUES ('455', '63', '184', null, null, '0', null, null, null, '3', '41.9', '0', '2014-11-28 05:54:02', null, '0', '1417125242414005', '5484', '2', '13911342615', '孔雷', '北京市昌平区天通苑天通东苑三区白杨', '0', '0');
INSERT INTO `bill` VALUES ('456', '63', '184', null, null, '0', null, null, null, '3', '41.9', '8', '2014-11-28 08:57:40', null, '0', '1417136260625000', '4474', '2', '13911342615', '孔雷', '北京市昌平区天通苑天通东苑三区白杨', '0', '0');
INSERT INTO `bill` VALUES ('457', '63', '184', null, null, '0', null, null, null, '3', '41.9', '8', '2014-11-28 09:01:35', null, '0', '1417136495710000', '6163', '2', '13911342615', '孔雷', '北京市昌平区天通苑天通东苑三区白杨', '0', '0');
INSERT INTO `bill` VALUES ('458', '63', '184', null, null, '0', null, null, null, '3', '41.9', '0', '2014-11-28 09:07:25', null, '0', '1417136845625001', '2566', '2', '13911342615', '孔雷', '北京市昌平区天通苑天通东苑三区白杨', '0', '0');
INSERT INTO `bill` VALUES ('459', '83', '199', null, null, '0', null, null, null, '3', '122.600006', '0', '2014-11-28 09:11:50', null, '0', '1417137110484002', '0044', '19', '15201351249', '江哥', '北京市昌平区天通苑天通东苑一区哈哈接口', '0', '0');
INSERT INTO `bill` VALUES ('460', '70', '179', null, null, '0', null, null, null, '3', '46.5', '0', '2014-11-28 09:28:48', null, '0', '1417138128965003', '5160', '4', '13810497654', '吴柯维', '北京市昌平区天通苑天通东苑二区301', '0', '0');
INSERT INTO `bill` VALUES ('461', '63', '0', null, null, '0', null, null, null, '3', '41.9', '0', '2014-11-28 09:37:28', null, '0', '1417138648026004', '7866', '2', '13911342615', '(null)', '(null)', '0', '0');
INSERT INTO `bill` VALUES ('462', '63', '0', null, null, '0', null, null, null, '3', '41.9', '0', '2014-11-28 09:38:19', null, '0', '1417138699762005', '4386', '2', '13911342615', '(null)', '(null)', '0', '0');
INSERT INTO `bill` VALUES ('463', '70', '179', null, null, '0', null, null, null, '3', '10.1', '0', '2014-11-28 09:41:40', null, '0', '1417138900612006', '6032', '3', '13810497654', '吴柯维', '北京市昌平区天通苑天通东苑二区301', '0', '0');
INSERT INTO `bill` VALUES ('464', '63', '198', null, null, '0', null, null, null, '3', '35.0', '0', '2014-11-28 10:19:20', null, '0', '1417141160994055', '0782', '1', '13911342615', '我们', '北京市昌平区天通苑天通东苑二区 哈哈哈', '0', '0');
INSERT INTO `bill` VALUES ('465', '63', '198', null, null, '0', null, null, null, '3', '35.0', '0', '2014-11-28 10:19:22', null, '0', '1417141162537056', '8663', '1', '13911342615', '我们', '北京市昌平区天通苑天通东苑二区 哈哈哈', '0', '0');
INSERT INTO `bill` VALUES ('466', '69', '178', null, null, '0', null, null, null, '3', '12.7', '0', '2014-11-28 16:07:43', null, '0', '1417162063522057', '8413', '2', '15201351249', '王振江', '北京市昌平区天通苑天通东苑一区测试，请勿取消订单', '0', '0');
INSERT INTO `bill` VALUES ('467', '85', '200', null, null, '0', null, null, null, '3', '17.0', '0', '2014-11-29 17:02:27', null, '0', '1417251747613000', '6772', '2', '17701384344', '赵鑫', '北京市昌平区天通苑天通东苑一区 天通苑东一区33号楼301', '0', '0');
INSERT INTO `bill` VALUES ('468', '68', '0', null, null, '0', null, null, null, '3', '14.0', '8', '2014-12-01 18:09:53', null, '0', '1417428593020000', '3120', '2', '18510336313', '(null)', '(null)', '0', '0');
INSERT INTO `bill` VALUES ('469', '68', '0', null, null, '0', null, null, null, '3', '35.0', '10', '2014-12-01 18:11:14', null, '0', '1417428674770001', '0007', '5', '18510336313', '(null)', '(null)', '0', '0');
INSERT INTO `bill` VALUES ('470', '68', '0', null, null, '0', null, null, null, '3', '35.0', '10', '2014-12-01 18:11:15', null, '0', '1417428675261002', '8082', '5', '18510336313', '(null)', '(null)', '0', '0');
INSERT INTO `bill` VALUES ('471', '63', '183', null, null, '0', null, null, null, '3', '35.0', '8', '2014-12-01 18:33:00', null, '0', '1417429980646008', '6178', '1', '13911342615', '孔雷', '北京市海淀区新都建材城西二里  硅谷小区2栋 106', '0', '0');
INSERT INTO `bill` VALUES ('472', '69', '178', null, null, '0', null, null, null, '3', '11.5', '8', '2014-12-01 18:35:36', null, '0', '1417430136239009', '1085', '2', '15201351249', '王振江', '北京市昌平区天通苑天通东苑一区测试，请勿取消订单', '0', '0');
INSERT INTO `bill` VALUES ('473', '69', '203', null, null, '0', null, null, null, '3', '14.0', '8', '2014-12-01 22:41:08', null, '0', '1417444868100018', '5718', '2', '15201351249', '家庭', '北京市昌平区天通苑天通东苑二区 不知道怎么', '0', '0');
INSERT INTO `bill` VALUES ('474', '69', '203', null, null, '0', null, null, null, '3', '14.0', '8', '2014-12-01 22:41:19', null, '0', '1417444879244019', '3400', '2', '15201351249', '家庭', '北京市昌平区天通苑天通东苑二区 不知道怎么', '0', '0');
INSERT INTO `bill` VALUES ('475', '69', '203', null, null, '0', null, null, null, '3', '61.5', '8', '2014-12-01 22:41:27', null, '0', '1417444887868020', '1111', '7', '15201351249', '家庭', '北京市昌平区天通苑天通东苑二区 不知道怎么', '0', '0');
INSERT INTO `bill` VALUES ('476', '69', '203', null, null, '0', null, null, null, '3', '61.5', '0', '2014-12-01 22:53:06', null, '0', '1417445586906021', '1801', '7', '15201351249', '家庭', '北京市昌平区天通苑天通东苑二区 不知道怎么', '0', '0');
INSERT INTO `bill` VALUES ('477', '69', '203', null, null, '0', null, null, null, '3', '47.9', '0', '2014-12-01 23:56:33', null, '0', '1417449393946033', '0725', '1', '15201351249', '家庭', '北京市昌平区天通苑天通东苑二区 不知道怎么', '0', '0');
INSERT INTO `bill` VALUES ('478', '69', '203', null, null, '0', null, null, null, '3', '47.9', '0', '2014-12-01 23:56:36', null, '0', '1417449396502034', '3856', '1', '15201351249', '家庭', '北京市昌平区天通苑天通东苑二区 不知道怎么', '0', '0');
INSERT INTO `bill` VALUES ('479', '69', '203', null, null, '0', null, null, null, '3', '47.9', '0', '2014-12-01 23:56:50', null, '0', '1417449410726035', '5583', '1', '15201351249', '家庭', '北京市昌平区天通苑天通东苑二区 不知道怎么', '0', '0');
INSERT INTO `bill` VALUES ('480', '69', '203', null, null, '0', null, null, null, '3', '137.8', '0', '2014-12-02 00:03:26', null, '0', '1417449806055000', '8236', '27', '15201351249', '家庭', '北京市昌平区天通苑天通东苑二区 不知道怎么', '0', '0');
INSERT INTO `bill` VALUES ('481', '63', '0', null, null, '0', null, null, null, '3', '10.7', '0', '2014-12-03 02:13:20', null, '0', '1417544000321000', '4634', '3', '13911342615', '(null)', '(null)', '0', '0');
INSERT INTO `bill` VALUES ('482', '63', '210', null, null, '0', null, null, null, '3', '10.7', '0', '2014-12-03 02:18:41', null, '0', '1417544321280001', '1784', '3', '13412345678', '牛牛牛', '北京市昌平区天通苑天通东苑二区 我么么', '0', '0');
INSERT INTO `bill` VALUES ('483', '63', '209', null, null, '0', null, null, null, '3', '10.7', '0', '2014-12-03 02:19:10', null, '0', '1417544350879002', '0207', '3', '13911342615', '擦擦', '北京市昌平区天通苑天通东苑二区 哈哈哈', '0', '0');
INSERT INTO `bill` VALUES ('484', '63', '209', null, null, '0', null, null, null, '3', '10.7', '0', '2014-12-03 02:19:12', null, '0', '1417544352564003', '1543', '3', '13911342615', '擦擦', '北京市昌平区天通苑天通东苑二区 哈哈哈', '0', '0');
INSERT INTO `bill` VALUES ('485', '63', '209', null, null, '0', null, null, null, '3', '33.0', '0', '2014-12-03 02:26:19', null, '0', '1417544779095004', '6545', '2', '13911342615', '擦擦', '北京市昌平区天通苑天通东苑二区 哈哈哈', '0', '0');
INSERT INTO `bill` VALUES ('486', '63', '210', null, null, '0', null, null, null, '3', '33.0', '0', '2014-12-03 02:33:17', null, '0', '1417545197857005', '8175', '2', '13412345678', '牛牛牛', '北京市昌平区天通苑天通东苑二区 我么么', '0', '0');
INSERT INTO `bill` VALUES ('487', '63', '211', null, null, '0', null, null, null, '3', '33.0', '0', '2014-12-03 03:42:57', null, '0', '1417549377739006', '3186', '2', '13112345678', '咱们', '北京市昌平区天通苑天通东苑三区 走在一条路', '0', '0');
INSERT INTO `bill` VALUES ('488', '63', '211', null, null, '0', null, null, null, '3', '10.4', '0', '2014-12-03 04:12:05', null, '0', '1417551125643007', '5277', '2', '13112345678', '咱们', '北京市昌平区天通苑天通东苑三区 走在一条路', '0', '0');
INSERT INTO `bill` VALUES ('489', '63', '211', null, null, '0', null, null, null, '3', '10.4', '0', '2014-12-03 04:17:44', null, '0', '1417551464384008', '3720', '2', '13112345678', '咱们', '北京市昌平区天通苑天通东苑三区 走在一条路', '0', '0');
INSERT INTO `bill` VALUES ('490', '68', '191', null, null, '0', null, null, null, '3', '10.6', '0', '2014-12-03 11:42:46', null, '0', '1417578166957009', '5647', '3', '18510336313', '张力', '北京市昌平区天通苑天通东苑二区 天通苑', '0', '0');
INSERT INTO `bill` VALUES ('491', '89', '212', null, null, '0', null, null, null, '3', '11.2', '0', '2014-12-03 21:31:33', null, '0', '1417613493887028', '4770', '4', '18907982580', '徐翔', '北京市昌平区天通苑天通东苑一区12座2107', '0', '0');
INSERT INTO `bill` VALUES ('492', '69', '203', null, null, '0', null, null, null, '3', '20.7', '0', '2014-12-03 22:58:37', null, '0', '1417618717474029', '1662', '4', '15201351249', '家庭', '北京市昌平区天通苑天通东苑二区不知道怎么减肥', '0', '0');
INSERT INTO `bill` VALUES ('493', '89', '212', null, null, '0', null, null, null, '3', '11.2', '0', '2014-12-03 23:01:29', null, '0', '1417618889779030', '7475', '4', '18907982580', '徐翔', '北京市昌平区天通苑天通东苑一区12座2107', '0', '0');
INSERT INTO `bill` VALUES ('494', '70', '179', null, null, '0', null, null, null, '3', '12.0', '0', '2014-12-04 01:10:12', null, '0', '1417626612357000', '1562', '3', '13810497654', '吴柯维', '北京市昌平区天通苑天通东苑二区 301', '0', '0');
INSERT INTO `bill` VALUES ('495', '89', '212', null, null, '0', null, null, null, '3', '10.2', '0', '2014-12-04 09:28:00', null, '0', '1417656480210001', '3487', '4', '18907982580', '徐翔', '北京市昌平区天通苑天通东苑一区12座2107', '0', '0');
INSERT INTO `bill` VALUES ('496', '90', '213', null, null, '0', null, null, null, '3', '12.0', '0', '2014-12-04 17:36:58', null, '0', '1417685818101002', '3477', '4', '13810108431', '林咸元', '北京市海淀区新都北新家园北新家园', '0', '0');
INSERT INTO `bill` VALUES ('497', '91', '0', null, null, '0', null, null, null, '3', '15.9', '0', '2014-12-04 18:04:55', null, '0', '1417687495185003', '4331', '1', '(null)', '(null)', '(null)', '0', '0');
INSERT INTO `bill` VALUES ('498', '92', '215', null, null, '0', null, null, null, '3', '18.0', '0', '2014-12-04 22:47:00', null, '0', '1417704420949004', '0344', '6', '18610210465', '李先生', '北京市昌平区天通苑天通东苑一区33号楼3单元101', '0', '0');
INSERT INTO `bill` VALUES ('499', '69', '203', null, null, '0', null, null, null, '3', '16.5', '0', '2014-12-05 10:55:36', null, '0', '1417748136830000', '8068', '3', '15201351249', '家庭', '北京市昌平区天通苑天通东苑二区不知道怎么减肥', '0', '0');
INSERT INTO `bill` VALUES ('500', '92', '215', null, null, '0', null, null, null, '3', '18.5', '0', '2014-12-06 13:59:37', null, '0', '1417845577659000', '7366', '3', '18610210465', '李先生', '北京市昌平区天通苑天通东苑一区33号楼3单元101', '0', '0');
INSERT INTO `bill` VALUES ('501', '92', '215', null, null, '0', null, null, null, '2', '17.0', '10', '2014-12-06 14:21:54', null, '0', '1417846914653001', '4352', '2', '18610210465', '李先生', '北京市昌平区天通苑天通东苑一区33号楼3单元101', '0', '0');
INSERT INTO `bill` VALUES ('502', '92', '215', null, null, '0', null, null, null, '3', '15.0', '10', '2014-12-06 14:26:05', null, '0', '1417847165829002', '4421', '1', '18610210465', '李先生', '北京市昌平区天通苑天通东苑一区33号楼3单元101', '0', '0');
INSERT INTO `bill` VALUES ('503', '85', '217', null, null, '0', null, null, null, '3', '16.5', '0', '2014-12-06 14:30:15', null, '0', '1417847415445003', '0616', '3', '17701384344', '赵鑫', '北京市昌平区天通苑天通东苑一区 测试地址。', '0', '0');
INSERT INTO `bill` VALUES ('504', '85', '217', null, null, '0', null, null, null, '3', '16.5', '0', '2014-12-06 14:30:17', null, '0', '1417847417851004', '2808', '3', '17701384344', '赵鑫', '北京市昌平区天通苑天通东苑一区 测试地址。', '0', '0');
INSERT INTO `bill` VALUES ('505', '101', '218', null, null, '0', null, null, null, '3', '128.5', '0', '2014-12-06 16:57:18', null, '0', '1417856238066005', '2157', '4', '15810191284', '李大伟', '北京市海淀区新都硅谷小区无', '0', '0');
INSERT INTO `bill` VALUES ('506', '102', '219', null, null, '0', null, null, null, '3', '21.3', '10', '2014-12-06 18:19:31', null, '0', '1417861171368006', '1555', '4', '18600120490', '双桥', '北京市昌平区天通苑天通东苑一区 测试', '0', '0');
INSERT INTO `bill` VALUES ('507', '106', '221', null, null, '0', null, null, null, '3', '12.0', '0', '2014-12-08 17:00:18', null, '0', '1418029218721000', '0705', '3', '18610606765', '赵先生', '北京市昌平区天通苑天通东苑一区 19号楼', '0', '0');
INSERT INTO `bill` VALUES ('508', '106', '221', null, null, '0', null, null, null, '3', '12.0', '0', '2014-12-08 17:00:18', null, '0', '1418029218824002', '4526', '3', '18610606765', '赵先生', '北京市昌平区天通苑天通东苑一区 19号楼', '0', '0');
INSERT INTO `bill` VALUES ('509', '106', '221', null, null, '0', null, null, null, '3', '12.0', '0', '2014-12-08 17:00:18', null, '0', '1418029218823001', '1848', '3', '18610606765', '赵先生', '北京市昌平区天通苑天通东苑一区 19号楼', '0', '0');
INSERT INTO `bill` VALUES ('510', '106', '221', null, null, '0', null, null, null, '3', '12.0', '0', '2014-12-08 17:00:18', null, '0', '1418029218970003', '3360', '3', '18610606765', '赵先生', '北京市昌平区天通苑天通东苑一区 19号楼', '0', '0');
INSERT INTO `bill` VALUES ('511', '69', '178', null, null, '0', null, null, null, '3', '50.9', '0', '2014-12-09 15:28:29', null, '0', '1418110109396000', '4782', '8', '15201351249', '王振江', '北京市昌平区天通苑天通东苑一区测试，请勿取消订单', '0', '0');
INSERT INTO `bill` VALUES ('512', '66', '223', null, null, '0', null, null, null, '3', '28.4', '0', '2014-12-09 17:57:20', null, '0', '1418119040708001', '1585', '5', '15056694639', '海子', '北京市昌平区天通苑天通东苑一区 一条街', '0', '0');
INSERT INTO `bill` VALUES ('513', '66', '223', null, null, '0', null, null, null, '3', '28.4', '0', '2014-12-09 17:57:22', null, '0', '1418119042602002', '2564', '5', '15056694639', '海子', '北京市昌平区天通苑天通东苑一区 一条街', '0', '0');
INSERT INTO `bill` VALUES ('514', '66', '223', null, null, '0', null, null, null, '3', '28.4', '0', '2014-12-09 17:57:23', null, '0', '1418119043520003', '1127', '5', '15056694639', '海子', '北京市昌平区天通苑天通东苑一区 一条街', '0', '0');
INSERT INTO `bill` VALUES ('515', '109', '224', null, null, '0', null, null, null, '3', '22.1', '8', '2014-12-09 18:06:10', null, '0', '1418119570637004', '7056', '2', '13910900287', '立', '北京市海淀区新都建材城西二里 你好', '0', '0');
INSERT INTO `bill` VALUES ('516', '63', '211', null, null, '0', null, null, null, '3', '23.0', '0', '2014-12-09 18:10:57', null, '0', '1418119857544005', '8173', '3', '13112345678', '咱们', '北京市昌平区天通苑天通东苑三区 走在一条路', '0', '0');
INSERT INTO `bill` VALUES ('517', '63', '211', null, null, '0', null, null, null, '3', '10.8', '0', '2014-12-09 18:11:31', null, '0', '1418119891645006', '1444', '3', '13112345678', '咱们', '北京市昌平区天通苑天通东苑三区 走在一条路', '0', '0');
INSERT INTO `bill` VALUES ('518', '63', '211', null, null, '0', null, null, null, '3', '11.0', '0', '2014-12-09 18:13:32', null, '0', '1418120012099007', '7846', '2', '13112345678', '咱们', '北京市昌平区天通苑天通东苑三区 走在一条路', '0', '0');
INSERT INTO `bill` VALUES ('519', '69', '203', null, null, '0', null, null, null, '3', '82.8', '0', '2014-12-09 20:40:02', null, '0', '1418128802180009', '6680', '17', '15201351249', '家庭', '北京市昌平区天通苑天通东苑二区 不知道怎么减肥', '0', '0');
INSERT INTO `bill` VALUES ('520', '69', '203', null, null, '0', null, null, null, '3', '12.5', '0', '2014-12-09 21:01:14', null, '0', '1418130074026010', '1468', '3', '15201351249', '测试', '北京市昌平区天通苑天通东苑二区 测试，请勿接单', '0', '0');
INSERT INTO `bill` VALUES ('521', '110', '225', null, null, '0', null, null, null, '3', '11.9', '0', '2014-12-10 14:43:02', null, '0', '1418193782101000', '2180', '2', '13845233365', '加南村', '北京市海淀区新都北新家园啊啊啊啊', '0', '0');
INSERT INTO `bill` VALUES ('522', '113', '0', null, null, '0', null, null, null, '3', '73.3', '8', '2014-12-11 01:16:09', null, '0', '1418231769737000', '2032', '4', '(null)', '(null)', '(null)', '0', '0');
INSERT INTO `bill` VALUES ('523', '113', '0', null, null, '0', null, null, null, '3', '73.3', '8', '2014-12-11 01:16:10', null, '0', '1418231770390001', '0022', '4', '(null)', '(null)', '(null)', '0', '0');
INSERT INTO `bill` VALUES ('524', '113', '0', null, null, '0', null, null, null, '3', '73.3', '8', '2014-12-11 01:16:21', null, '0', '1418231781766002', '5715', '4', '(null)', '(null)', '(null)', '0', '0');
INSERT INTO `bill` VALUES ('525', '120', '0', null, null, '0', null, null, null, '2', '20.3', '8', '2014-12-13 20:03:19', null, '0', '1418472199908000', '8341', '5', '(null)', '(null)', '(null)', '0', '0');
INSERT INTO `bill` VALUES ('526', '122', '228', null, null, '0', null, null, null, '3', '41.699997', '0', '2014-12-13 22:57:06', null, '0', '1418482626155001', '5443', '6', '15611063333', '吃不饱那', '北京市昌平区天通苑天通东苑三区放个假加减了吗', '0', '0');
INSERT INTO `bill` VALUES ('527', '124', '229', null, null, '0', null, null, null, '3', '15.0', '0', '2014-12-14 18:40:44', null, '0', '1418553644775000', '6736', '5', '13912345678', 'd', '北京市昌平区天通苑天通东苑二区y', '0', '0');
INSERT INTO `bill` VALUES ('528', '127', '0', null, null, '0', null, null, null, '3', '11.9', '0', '2014-12-15 14:29:53', null, '0', '1418624992994000', '6763', '2', '(null)', '(null)', '(null)', '0', '0');
INSERT INTO `bill` VALUES ('529', '136', '0', '0', '0', '0', '0', null, null, '3', '10.2', '8', '2014-12-20 09:15:19', null, '0', '1419038119847000', '6522', '2', '(null)', '(null)', '(null)', '0', '0');
INSERT INTO `bill` VALUES ('530', '136', '0', '0', '0', '0', '0', null, null, '3', '10.2', '8', '2014-12-20 09:15:31', null, '0', '1419038131792001', '5842', '2', '(null)', '(null)', '(null)', '0', '0');
INSERT INTO `bill` VALUES ('531', '136', '0', '0', '0', '0', '0', null, null, '3', '10.2', '8', '2014-12-20 09:15:35', null, '0', '1419038135730002', '5166', '2', '(null)', '(null)', '(null)', '0', '0');
INSERT INTO `bill` VALUES ('532', '136', '0', '0', '0', '0', '0', null, null, '3', '10.2', '0', '2014-12-20 09:15:39', null, '0', '1419038139759003', '4370', '2', '(null)', '(null)', '(null)', '0', '0');
INSERT INTO `bill` VALUES ('533', '136', '0', '0', '0', '0', '0', null, null, '3', '10.2', '8', '2014-12-20 09:15:50', null, '0', '1419038150626004', '8262', '2', '(null)', '(null)', '(null)', '0', '0');
INSERT INTO `bill` VALUES ('534', '136', '0', '0', '0', '0', '0', null, null, '3', '10.2', '8', '2014-12-20 09:15:52', null, '0', '1419038152545005', '1713', '2', '(null)', '(null)', '(null)', '0', '0');
INSERT INTO `bill` VALUES ('535', '120', '227', '0', '0', '0', '0', null, null, '3', '28.5', '0', '2014-12-21 10:39:34', null, '0', '1419129574356000', '5463', '7', '17710023336', '林杨', '北京市昌平区天通苑天通东苑一区 天通苑东一区34号楼1301', '0', '0');
INSERT INTO `bill` VALUES ('536', '138', '235', '0', '0', '0', '0', null, null, '2', '31.6', '8', '2014-12-22 16:55:19', null, '0', '1419238519335000', '2321', '4', '13701124311', '孙宁', '北京市昌平区天通苑天通东苑一区44-4-301', '0', '0');
INSERT INTO `bill` VALUES ('537', '68', '191', '0', '0', '0', '0', null, null, '3', '32.9', '0', '2014-12-24 14:16:16', null, '0', '1419401776009000', '1006', '1', '18510336313', '张力', '北京市昌平区天通苑天通东苑二区天通苑（测试勿接单）', '0', '0');
INSERT INTO `bill` VALUES ('538', '147', '238', '0', '0', '0', '0', null, null, '3', '109.600006', '0', '2014-12-24 14:27:23', null, '0', '1419402443636001', '4438', '10', '18612781478', '段俊', '北京市海淀区--西土城路10号院     测试', '0', '0');
INSERT INTO `bill` VALUES ('539', '69', '203', '0', '0', '0', '0', null, null, '3', '45.0', '8', '2014-12-24 15:47:08', null, '0', '1419407228555002', '1710', '2', '15201351249', '测试', '北京市昌平区天通苑天通东苑二区测试，请勿接单', '0', '0');
INSERT INTO `bill` VALUES ('540', '69', '203', '0', '0', '0', '0', null, null, '3', '13.3', '0', '2014-12-24 18:34:35', null, '0', '1419417275464003', '8428', '3', '15201351249', '测试', '北京市昌平区天通苑天通东苑二区 测试，请勿接单', '0', '0');
INSERT INTO `bill` VALUES ('541', '148', '240', '0', '0', '0', '0', null, null, '3', '19.0', '8', '2014-12-25 10:09:20', null, '0', '1419473360046000', '4184', '6', '13186986147', '韦玉', '杭州市拱墅区--万家花城二期26幢603', '0', '0');
INSERT INTO `bill` VALUES ('542', '150', '241', '0', '0', '0', '0', null, null, '3', '72.7', '8', '2014-12-25 10:34:30', null, '0', '1419474870119001', '6015', '2', '15715513876', '姚健', '北京市海淀区新都建材城西二里 3号楼1207', '0', '0');
INSERT INTO `bill` VALUES ('543', '145', '242', '0', '0', '0', '0', null, null, '3', '17.68', '10', '2014-12-25 11:37:45', null, '0', '1419478665116002', '8260', '4', '13910699788', '于洪', '北京市昌平区--天通苑太平家园23-708', '0', '0');
...
CREATE TABLE `bill_history` (
  ...
  `delivery_address_id` int(11) DEFAULT '0' COMMENT '送货地址',
  `delivery_address_stamp` int(11) DEFAULT '0' COMMENT '配送地址版本',
  `pay_status` int(11) DEFAULT NULL COMMENT '支付状态0=未支付1=已支付',
  `pay_type` int(11) DEFAULT '0' COMMENT '支付类型',
  `actual_pay_type` int(11) DEFAULT '0' COMMENT '实际支付类型',
  `reserved_delivery_time` varchar(20) DEFAULT NULL COMMENT '预约送货时间',
  `actual_delivery_time` varchar(11) DEFAULT NULL COMMENT '实际送货时间',
  `bill_status` int(11) DEFAULT '0' COMMENT '订单状态',
  `total_price` varchar(0) DEFAULT NULL COMMENT '总价',
  `delivery_id` int(20) DEFAULT '0' COMMENT '配送员',
  `createtime` timestamp NULL DEFAULT NULL COMMENT '下单时间',
  `log_user_id` int(11) DEFAULT NULL COMMENT '操作用户',
...
CREATE TABLE `bill_items` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1252 DEFAULT CHARSET=utf8 COMMENT='订单详情';

-- ----------------------------
-- Records of bill_items
-- ----------------------------
INSERT INTO `bill_items` VALUES ('934', '1000506', null, '9', null, '1414300244769007', '5.5');
INSERT INTO `bill_items` VALUES ('935', '1000504', null, '1', null, '1414306432989008', '5');
INSERT INTO `bill_items` VALUES ('936', '1000625', null, '2', null, '1414306432989008', '3');
INSERT INTO `bill_items` VALUES ('937', '1000550', null, '1', null, '1414306432989008', '3.5');
INSERT INTO `bill_items` VALUES ('938', '1000593', null, '1', null, '1414306432989008', '4');
INSERT INTO `bill_items` VALUES ('939', '1000583', null, '1', null, '1414306432989008', '5');
INSERT INTO `bill_items` VALUES ('940', '1000581', null, '2', null, '1414306432989008', '3.8');
INSERT INTO `bill_items` VALUES ('941', '1000548', null, '1', null, '1414306714846009', '3.5');
INSERT INTO `bill_items` VALUES ('942', '1000625', null, '2', null, '1414306714846009', '3');
INSERT INTO `bill_items` VALUES ('943', '1000504', null, '1', null, '1414306714846009', '5');
INSERT INTO `bill_items` VALUES ('944', '1000593', null, '1', null, '1414306714846009', '4');
INSERT INTO `bill_items` VALUES ('945', '1000583', null, '1', null, '1414306714846009', '5');
INSERT INTO `bill_items` VALUES ('946', '1000581', null, '2', null, '1414306714846009', '3.8');
INSERT INTO `bill_items` VALUES ('947', '1000610', null, '1', null, '1414402200693000', '7');
INSERT INTO `bill_items` VALUES ('948', '1000682', null, '1', null, '1414402200693000', '47.9');
INSERT INTO `bill_items` VALUES ('949', '1000506', null, '1', null, '1414402200693000', '5.5');
INSERT INTO `bill_items` VALUES ('950', '1000679', null, '4', null, '1414402253648001', '18.9');
INSERT INTO `bill_items` VALUES ('951', '1000505', null, '2', null, '1414402894773002', '7.2');
INSERT INTO `bill_items` VALUES ('952', '1000504', null, '2', null, '1414402894773002', '5');
INSERT INTO `bill_items` VALUES ('953', '1000506', null, '2', null, '1414402894773002', '5.5');
INSERT INTO `bill_items` VALUES ('954', '1000505', null, '2', null, '1414403621184003', '7.2');
INSERT INTO `bill_items` VALUES ('955', '1000504', null, '2', null, '1414403621184003', '5');
INSERT INTO `bill_items` VALUES ('956', '1000506', null, '1', null, '1414403621184003', '5.5');
INSERT INTO `bill_items` VALUES ('957', '1000680', null, '1', null, '1414419437366000', '59');
INSERT INTO `bill_items` VALUES ('958', '1000505', null, '2', null, '1414426648282000', '7.2');
INSERT INTO `bill_items` VALUES ('959', '1000504', null, '2', null, '1414426648282000', '5');
INSERT INTO `bill_items` VALUES ('960', '1000506', null, '2', null, '1414426648282000', '5.5');
INSERT INTO `bill_items` VALUES ('961', '1000505', null, '2', null, '1414469199501001', '7.2');
INSERT INTO `bill_items` VALUES ('962', '1000504', null, '3', null, '1414469199501001', '5');
INSERT INTO `bill_items` VALUES ('963', '1000506', null, '2', null, '1414469199501001', '5.5');
INSERT INTO `bill_items` VALUES ('964', '1000505', null, '2', null, '1414469965478002', '7.2');
INSERT INTO `bill_items` VALUES ('965', '1000504', null, '1', null, '1414469965478002', '5');
INSERT INTO `bill_items` VALUES ('966', '1000506', null, '2', null, '1414469965478002', '5.5');
INSERT INTO `bill_items` VALUES ('967', '1000685', null, '1', null, '1415245643812000', '35');
INSERT INTO `bill_items` VALUES ('968', '1000650', null, '2', null, '1415335964389000', '26');
INSERT INTO `bill_items` VALUES ('969', '1000721', null, '1', null, '1415428577283000', '9.5');
INSERT INTO `bill_items` VALUES ('970', '1000582', null, '2', null, '1415428577283000', '3.5');
INSERT INTO `bill_items` VALUES ('971', '1000592', null, '2', null, '1415428577283000', '3');
INSERT INTO `bill_items` VALUES ('972', '1000627', null, '4', null, '1415428577283000', '2');
INSERT INTO `bill_items` VALUES ('973', '1000720', null, '2', null, '1415429250480001', '4.5');
INSERT INTO `bill_items` VALUES ('974', '1000571', null, '3', null, '1415429250480001', '2.5');
INSERT INTO `bill_items` VALUES ('975', '1000630', null, '2', null, '1415429250480001', '2');
INSERT INTO `bill_items` VALUES ('976', '1000627', null, '5', null, '1415429250480001', '2');
INSERT INTO `bill_items` VALUES ('977', '1000705', null, '8', null, '1416107877080000', '1.8');
INSERT INTO `bill_items` VALUES ('978', '1000585', null, '2', null, '1416107877080000', '4.2');
INSERT INTO `bill_items` VALUES ('979', '1000753', null, '3', null, '1416107877080000', '1');
INSERT INTO `bill_items` VALUES ('980', '1000686', null, '1', null, '1416107877080000', '35');
INSERT INTO `bill_items` VALUES ('981', '1000746', null, '2', null, '1416107877080000', '2.5');
INSERT INTO `bill_items` VALUES ('982', '1000595', null, '1', null, '1416107877080000', '3');
INSERT INTO `bill_items` VALUES ('983', '1000626', null, '2', null, '1416107877080000', '1.6');
INSERT INTO `bill_items` VALUES ('984', '1000599', null, '1', null, '1416107877080000', '3.5');
INSERT INTO `bill_items` VALUES ('985', '1000705', null, '8', null, '1416108332854001', '1.8');
INSERT INTO `bill_items` VALUES ('986', '1000753', null, '3', null, '1416108332854001', '1');
INSERT INTO `bill_items` VALUES ('987', '1000585', null, '2', null, '1416108332854001', '4.2');
INSERT INTO `bill_items` VALUES ('988', '1000686', null, '1', null, '1416108332854001', '35');
INSERT INTO `bill_items` VALUES ('989', '1000746', null, '2', null, '1416108332854001', '2.5');
INSERT INTO `bill_items` VALUES ('990', '1000595', null, '1', null, '1416108332854001', '3');
INSERT INTO `bill_items` VALUES ('991', '1000626', null, '2', null, '1416108332854001', '1.6');
INSERT INTO `bill_items` VALUES ('992', '1000599', null, '1', null, '1416108332854001', '3.5');
INSERT INTO `bill_items` VALUES ('993', '1000685', null, '1', null, '1416116701209002', '35');
INSERT INTO `bill_items` VALUES ('994', '1000793', null, '1', null, '1416116701209002', '8.5');
INSERT INTO `bill_items` VALUES ('995', '1000511', null, '1', null, '1416116701209002', '10');
INSERT INTO `bill_items` VALUES ('996', '1000570', null, '1', null, '1416116701209002', '3');
INSERT INTO `bill_items` VALUES ('997', '1000729', null, '2', null, '1416140687661003', '18');
INSERT INTO `bill_items` VALUES ('998', '1000507', null, '2', null, '1416140687661003', '4.9');
INSERT INTO `bill_items` VALUES ('999', '1000506', null, '1', null, '1416140687661003', '5.5');
INSERT INTO `bill_items` VALUES ('1000', '1000509', null, '1', null, '1416140687661003', '6');
INSERT INTO `bill_items` VALUES ('1001', '1000508', null, '2', null, '1416140687661003', '6');
INSERT INTO `bill_items` VALUES ('1002', '1000505', null, '2', null, '1416214471984000', '7.2');
INSERT INTO `bill_items` VALUES ('1003', '1000504', null, '1', null, '1416214471984000', '5');
INSERT INTO `bill_items` VALUES ('1004', '1000506', null, '2', null, '1416214471984000', '5.5');
INSERT INTO `bill_items` VALUES ('1005', '1000638', null, '2', null, '1416214471984000', '5.9');
INSERT INTO `bill_items` VALUES ('1006', '1000639', null, '2', null, '1416214471984000', '5.5');
INSERT INTO `bill_items` VALUES ('1007', '1000509', null, '1', null, '1416284167157000', '6');
INSERT INTO `bill_items` VALUES ('1008', '1000508', null, '1', null, '1416284167157000', '6');
INSERT INTO `bill_items` VALUES ('1009', '1000507', null, '2', null, '1416284167157000', '4.9');
INSERT INTO `bill_items` VALUES ('1010', '1000506', null, '2', null, '1416284167157000', '5.5');
INSERT INTO `bill_items` VALUES ('1011', '1000685', null, '1', null, '1416285768572001', '35');
INSERT INTO `bill_items` VALUES ('1012', '1000686', null, '1', null, '1416285768572001', '35');
INSERT INTO `bill_items` VALUES ('1013', '1000518', null, '1', null, '1416817734339000', '9.5');
INSERT INTO `bill_items` VALUES ('1014', '1000619', null, '3', null, '1416817734339000', '2.5');
INSERT INTO `bill_items` VALUES ('1015', '1000512', null, '1', null, '1416817734339000', '7.2');
INSERT INTO `bill_items` VALUES ('1016', '1000579', null, '1', null, '1416817734339000', '3.5');
INSERT INTO `bill_items` VALUES ('1017', '1000543', null, '1', null, '1416817734339000', '8.3');
INSERT INTO `bill_items` VALUES ('1018', '1000625', null, '1', null, '1416817734339000', '3');
INSERT INTO `bill_items` VALUES ('1019', '1000506', null, '1', null, '1416817734339000', '5.5');
INSERT INTO `bill_items` VALUES ('1020', '1000570', null, '1', null, '1416817734339000', '3');
INSERT INTO `bill_items` VALUES ('1021', '1000521', null, '1', null, '1416817734339000', '4');
INSERT INTO `bill_items` VALUES ('1022', '1000797', null, '1', null, '1416890259630000', '7.5');
INSERT INTO `bill_items` VALUES ('1023', '1000685', null, '1', null, '1416890259630000', '35');
INSERT INTO `bill_items` VALUES ('1024', '1000799', null, '1', null, '1416890259630000', '7.5');
INSERT INTO `bill_items` VALUES ('1025', '1000798', null, '1', null, '1416890259630000', '7.5');
INSERT INTO `bill_items` VALUES ('1026', '1000637', null, '2', null, '1416890259630000', '7.9');
INSERT INTO `bill_items` VALUES ('1027', '1000800', null, '1', null, '1416890259630000', '7.5');
INSERT INTO `bill_items` VALUES ('1028', '1000505', null, '1', null, '1417111576814000', '7.2');
INSERT INTO `bill_items` VALUES ('1029', '1000506', null, '1', null, '1417111576814000', '5.5');
INSERT INTO `bill_items` VALUES ('1030', '1000505', null, '1', null, '1417111913781000', '7.2');
INSERT INTO `bill_items` VALUES ('1031', '1000506', null, '1', null, '1417111913781000', '5.5');
INSERT INTO `bill_items` VALUES ('1032', '1000579', null, '1', null, '1417112195112001', '3.5');
INSERT INTO `bill_items` VALUES ('1033', '1000638', null, '1', null, '1417112195112001', '5.9');
INSERT INTO `bill_items` VALUES ('1034', '1000639', null, '1', null, '1417112195112001', '5.5');
INSERT INTO `bill_items` VALUES ('1035', '1000640', null, '1', null, '1417112195112001', '5.5');
INSERT INTO `bill_items` VALUES ('1036', '1000584', null, '1', null, '1417117616896002', '4.5');
INSERT INTO `bill_items` VALUES ('1037', '1000680', null, '1', null, '1417117616896002', '59');
INSERT INTO `bill_items` VALUES ('1038', '1000650', null, '4', null, '1417117616896002', '26');
INSERT INTO `bill_items` VALUES ('1039', '1000505', null, '1', null, '1417117616896002', '7.2');
INSERT INTO `bill_items` VALUES ('1040', '1000506', null, '1', null, '1417117616896002', '5.5');
INSERT INTO `bill_items` VALUES ('1041', '1000688', null, '1', null, '1417117616896002', '3.8');
INSERT INTO `bill_items` VALUES ('1042', '1000689', null, '1', null, '1417117616896002', '3.8');
INSERT INTO `bill_items` VALUES ('1043', '1000690', null, '1', null, '1417117616896002', '3.8');
INSERT INTO `bill_items` VALUES ('1044', '1000506', null, '2', null, '1417117840666003', '5.5');
INSERT INTO `bill_items` VALUES ('1045', '1000677', null, '7', null, '1417118040065004', '2');
INSERT INTO `bill_items` VALUES ('1046', '1000650', null, '1', null, '1417125242414005', '26.00');
INSERT INTO `bill_items` VALUES ('1047', '1000678', null, '1', null, '1417125242414005', '15.90');
INSERT INTO `bill_items` VALUES ('1048', '1000650', null, '1', null, '1417136260625000', '26.00');
INSERT INTO `bill_items` VALUES ('1049', '1000678', null, '1', null, '1417136260625000', '15.90');
INSERT INTO `bill_items` VALUES ('1050', '1000650', null, '1', null, '1417136495710000', '26.00');
INSERT INTO `bill_items` VALUES ('1051', '1000678', null, '1', null, '1417136495710000', '15.90');
INSERT INTO `bill_items` VALUES ('1052', '1000650', null, '1', null, '1417136845625001', '26.00');
INSERT INTO `bill_items` VALUES ('1053', '1000678', null, '1', null, '1417136845625001', '15.90');
INSERT INTO `bill_items` VALUES ('1054', '1000586', null, '1', null, '1417137110484002', '4');
INSERT INTO `bill_items` VALUES ('1055', '1000650', null, '1', null, '1417137110484002', '26');
INSERT INTO `bill_items` VALUES ('1056', '1000505', null, '2', null, '1417137110484002', '7.2');
INSERT INTO `bill_items` VALUES ('1057', '1000579', null, '5', null, '1417137110484002', '3.5');
INSERT INTO `bill_items` VALUES ('1058', '1000578', null, '1', null, '1417137110484002', '3.6');
INSERT INTO `bill_items` VALUES ('1059', '1000506', null, '1', null, '1417137110484002', '5.5');
INSERT INTO `bill_items` VALUES ('1060', '1000678', null, '2', null, '1417137110484002', '15.9');
INSERT INTO `bill_items` VALUES ('1061', '1000571', null, '4', null, '1417137110484002', '2.5');
INSERT INTO `bill_items` VALUES ('1062', '1000580', null, '1', null, '1417137110484002', '6.8');
INSERT INTO `bill_items` VALUES ('1063', '1000570', null, '1', null, '1417137110484002', '3');
INSERT INTO `bill_items` VALUES ('1064', '1000650', null, '1', null, '1417138128965003', '26');
INSERT INTO `bill_items` VALUES ('1065', '1000571', null, '1', null, '1417138128965003', '2.5');
INSERT INTO `bill_items` VALUES ('1066', '1000574', null, '1', null, '1417138128965003', '15');
INSERT INTO `bill_items` VALUES ('1067', '1000570', null, '1', null, '1417138128965003', '3');
INSERT INTO `bill_items` VALUES ('1068', '1000650', null, '1', null, '1417138648026004', '26.00');
INSERT INTO `bill_items` VALUES ('1069', '1000678', null, '1', null, '1417138648026004', '15.90');
INSERT INTO `bill_items` VALUES ('1070', '1000650', null, '1', null, '1417138699762005', '26.00');
INSERT INTO `bill_items` VALUES ('1071', '1000678', null, '1', null, '1417138699762005', '15.90');
INSERT INTO `bill_items` VALUES ('1072', '1000579', null, '1', null, '1417138900612006', '3.5');
INSERT INTO `bill_items` VALUES ('1073', '1000578', null, '1', null, '1417138900612006', '3.6');
INSERT INTO `bill_items` VALUES ('1074', '1000570', null, '1', null, '1417138900612006', '3');
INSERT INTO `bill_items` VALUES ('1075', '1000685', null, '1', null, '1417141160994055', '35.00');
INSERT INTO `bill_items` VALUES ('1076', '1000685', null, '1', null, '1417141162537056', '35.00');
INSERT INTO `bill_items` VALUES ('1077', '1000505', null, '1', null, '1417162063522057', '7.2');
INSERT INTO `bill_items` VALUES ('1078', '1000506', null, '1', null, '1417162063522057', '5.5');
INSERT INTO `bill_items` VALUES ('1079', '1000512', null, '1', null, '1417251747613000', '7.20');
INSERT INTO `bill_items` VALUES ('1080', '1000736', null, '1', null, '1417251747613000', '9.80');
INSERT INTO `bill_items` VALUES ('1081', '1000577', null, '2', null, '1417428593020000', '7.00');
INSERT INTO `bill_items` VALUES ('1082', '1000577', null, '5', null, '1417428674770001', '7.00');
INSERT INTO `bill_items` VALUES ('1083', '1000577', null, '5', null, '1417428675261002', '7.00');
INSERT INTO `bill_items` VALUES ('1084', '1000685', null, '1', null, '1417429980646008', '35.00');
INSERT INTO `bill_items` VALUES ('1085', '1000508', null, '1', null, '1417430136239009', '6');
INSERT INTO `bill_items` VALUES ('1086', '1000506', null, '1', null, '1417430136239009', '5.5');
INSERT INTO `bill_items` VALUES ('1087', '1000720', null, '1', null, '1417444868100018', '4.50');
INSERT INTO `bill_items` VALUES ('1088', '1000721', null, '1', null, '1417444868100018', '9.50');
INSERT INTO `bill_items` VALUES ('1089', '1000720', null, '1', null, '1417444879244019', '4.50');
INSERT INTO `bill_items` VALUES ('1090', '1000721', null, '1', null, '1417444879244019', '9.50');
INSERT INTO `bill_items` VALUES ('1091', '1000720', null, '1', null, '1417444887868020', '4.50');
INSERT INTO `bill_items` VALUES ('1092', '1000721', null, '6', null, '1417444887868020', '9.50');
INSERT INTO `bill_items` VALUES ('1093', '1000720', null, '1', null, '1417445586906021', '4.50');
INSERT INTO `bill_items` VALUES ('1094', '1000721', null, '6', null, '1417445586906021', '9.50');
INSERT INTO `bill_items` VALUES ('1095', '1000682', null, '1', null, '1417449393946033', '47.90');
INSERT INTO `bill_items` VALUES ('1096', '1000682', null, '1', null, '1417449396502034', '47.90');
INSERT INTO `bill_items` VALUES ('1097', '1000682', null, '1', null, '1417449410726035', '47.90');
INSERT INTO `bill_items` VALUES ('1098', '1000508', null, '5', null, '1417449806055000', '6.00');
INSERT INTO `bill_items` VALUES ('1099', '1000507', null, '22', null, '1417449806055000', '4.90');
INSERT INTO `bill_items` VALUES ('1100', '1000578', null, '2', null, '1417544000321000', '3.60');
INSERT INTO `bill_items` VALUES ('1101', '1000579', null, '1', null, '1417544000321000', '3.50');
INSERT INTO `bill_items` VALUES ('1102', '1000578', null, '2', null, '1417544321280001', '3.60');
INSERT INTO `bill_items` VALUES ('1103', '1000579', null, '1', null, '1417544321280001', '3.50');
INSERT INTO `bill_items` VALUES ('1104', '1000578', null, '2', null, '1417544350879002', '3.60');
INSERT INTO `bill_items` VALUES ('1105', '1000579', null, '1', null, '1417544350879002', '3.50');
INSERT INTO `bill_items` VALUES ('1106', '1000578', null, '2', null, '1417544352564003', '3.60');
INSERT INTO `bill_items` VALUES ('1107', '1000579', null, '1', null, '1417544352564003', '3.50');
INSERT INTO `bill_items` VALUES ('1108', '1000731', null, '2', null, '1417544779095004', '16.50');
INSERT INTO `bill_items` VALUES ('1109', '1000731', null, '2', null, '1417545197857005', '16.50');
INSERT INTO `bill_items` VALUES ('1110', '1000731', null, '2', null, '1417549377739006', '16.50');
INSERT INTO `bill_items` VALUES ('1111', '1000506', null, '1', null, '1417551125643007', '5.50');
INSERT INTO `bill_items` VALUES ('1112', '1000507', null, '1', null, '1417551125643007', '4.90');
INSERT INTO `bill_items` VALUES ('1113', '1000506', null, '1', null, '1417551464384008', '5.50');
INSERT INTO `bill_items` VALUES ('1114', '1000507', null, '1', null, '1417551464384008', '4.90');
INSERT INTO `bill_items` VALUES ('1115', '1000570', null, '1', null, '1417578166957009', '3.00');
INSERT INTO `bill_items` VALUES ('1116', '1000572', null, '1', null, '1417578166957009', '3.80');
INSERT INTO `bill_items` VALUES ('1117', '1000689', null, '1', null, '1417578166957009', '3.80');
INSERT INTO `bill_items` VALUES ('1118', '1000624', null, '2', null, '1417613493887028', '3');
INSERT INTO `bill_items` VALUES ('1119', '1000778', null, '2', null, '1417613493887028', '2.6');
INSERT INTO `bill_items` VALUES ('1120', '1000508', null, '1', null, '1417618717474029', '6');
INSERT INTO `bill_items` VALUES ('1121', '1000507', null, '3', null, '1417618717474029', '4.9');
INSERT INTO `bill_items` VALUES ('1122', '1000624', null, '2', null, '1417618889779030', '3');
INSERT INTO `bill_items` VALUES ('1123', '1000778', null, '2', null, '1417618889779030', '2.6');
INSERT INTO `bill_items` VALUES ('1124', '1000724', null, '3', null, '1417626612357000', '4.00');
INSERT INTO `bill_items` VALUES ('1125', '1000620', null, '2', null, '1417656480210001', '2.5');
INSERT INTO `bill_items` VALUES ('1126', '1000778', null, '2', null, '1417656480210001', '2.6');
INSERT INTO `bill_items` VALUES ('1127', '1000625', null, '4', null, '1417685818101002', '3');
INSERT INTO `bill_items` VALUES ('1128', '1000678', null, '1', null, '1417687495185003', '15.90');
INSERT INTO `bill_items` VALUES ('1129', '1000570', null, '6', null, '1417704420949004', '3');
INSERT INTO `bill_items` VALUES ('1130', '1000506', null, '3', null, '1417748136830000', '5.5');
INSERT INTO `bill_items` VALUES ('1131', '1000647', null, '1', null, '1417845577659000', '10.3');
INSERT INTO `bill_items` VALUES ('1132', '1000687', null, '2', null, '1417845577659000', '4.1');
INSERT INTO `bill_items` VALUES ('1133', '1000793', null, '2', null, '1417846914653001', '8.5');
INSERT INTO `bill_items` VALUES ('1134', '1000574', null, '1', null, '1417847165829002', '15');
INSERT INTO `bill_items` VALUES ('1135', '1000506', null, '3', null, '1417847415445003', '5.50');
INSERT INTO `bill_items` VALUES ('1136', '1000506', null, '3', null, '1417847417851004', '5.50');
INSERT INTO `bill_items` VALUES ('1137', '1000831', null, '1', null, '1417856238066005', '18.9');
INSERT INTO `bill_items` VALUES ('1138', '1000827', null, '1', null, '1417856238066005', '36');
INSERT INTO `bill_items` VALUES ('1139', '1000826', null, '2', null, '1417856238066005', '36.8');
INSERT INTO `bill_items` VALUES ('1140', '1000519', null, '1', null, '1417861171368006', '9.50');
INSERT INTO `bill_items` VALUES ('1141', '1000521', null, '1', null, '1417861171368006', '4.00');
INSERT INTO `bill_items` VALUES ('1142', '1000522', null, '1', null, '1417861171368006', '3.80');
INSERT INTO `bill_items` VALUES ('1143', '1000523', null, '1', null, '1417861171368006', '4.00');
INSERT INTO `bill_items` VALUES ('1144', '1000724', null, '3', null, '1418029218721000', '4.00');
INSERT INTO `bill_items` VALUES ('1145', '1000724', null, '3', null, '1418029218824002', '4.00');
INSERT INTO `bill_items` VALUES ('1146', '1000724', null, '3', null, '1418029218823001', '4.00');
INSERT INTO `bill_items` VALUES ('1147', '1000724', null, '3', null, '1418029218970003', '4.00');
INSERT INTO `bill_items` VALUES ('1148', '1000505', null, '2', null, '1418110109396000', '7.2');
INSERT INTO `bill_items` VALUES ('1149', '1000721', null, '1', null, '1418110109396000', '9.5');
INSERT INTO `bill_items` VALUES ('1150', '1000720', null, '1', null, '1418110109396000', '4.5');
INSERT INTO `bill_items` VALUES ('1151', '1000782', null, '1', null, '1418110109396000', '6');
INSERT INTO `bill_items` VALUES ('1152', '1000506', null, '3', null, '1418110109396000', '5.5');
INSERT INTO `bill_items` VALUES ('1153', '1000506', null, '1', null, '1418119040708001', '5.50');
INSERT INTO `bill_items` VALUES ('1154', '1000507', null, '1', null, '1418119040708001', '4.90');
INSERT INTO `bill_items` VALUES ('1155', '1000509', null, '1', null, '1418119040708001', '6.00');
INSERT INTO `bill_items` VALUES ('1156', '1000508', null, '1', null, '1418119040708001', '6.00');
INSERT INTO `bill_items` VALUES ('1157', '1000510', null, '1', null, '1418119040708001', '6.00');
INSERT INTO `bill_items` VALUES ('1158', '1000506', null, '1', null, '1418119042602002', '5.50');
INSERT INTO `bill_items` VALUES ('1159', '1000507', null, '1', null, '1418119042602002', '4.90');
INSERT INTO `bill_items` VALUES ('1160', '1000509', null, '1', null, '1418119042602002', '6.00');
INSERT INTO `bill_items` VALUES ('1161', '1000508', null, '1', null, '1418119042602002', '6.00');
INSERT INTO `bill_items` VALUES ('1162', '1000510', null, '1', null, '1418119042602002', '6.00');
INSERT INTO `bill_items` VALUES ('1163', '1000506', null, '1', null, '1418119043520003', '5.50');
INSERT INTO `bill_items` VALUES ('1164', '1000507', null, '1', null, '1418119043520003', '4.90');
INSERT INTO `bill_items` VALUES ('1165', '1000509', null, '1', null, '1418119043520003', '6.00');
INSERT INTO `bill_items` VALUES ('1166', '1000508', null, '1', null, '1418119043520003', '6.00');
INSERT INTO `bill_items` VALUES ('1167', '1000510', null, '1', null, '1418119043520003', '6.00');
INSERT INTO `bill_items` VALUES ('1168', '1000729', null, '1', null, '1418119570637004', '18');
INSERT INTO `bill_items` VALUES ('1169', '1000687', null, '1', null, '1418119570637004', '4.1');
INSERT INTO `bill_items` VALUES ('1170', '1000719', null, '1', null, '1418119857544005', '9.00');
INSERT INTO `bill_items` VALUES ('1171', '1000720', null, '1', null, '1418119857544005', '4.50');
INSERT INTO `bill_items` VALUES ('1172', '1000721', null, '1', null, '1418119857544005', '9.50');
INSERT INTO `bill_items` VALUES ('1173', '1000578', null, '3', null, '1418119891645006', '3.60');
INSERT INTO `bill_items` VALUES ('1174', '1000506', null, '2', null, '1418120012099007', '5.50');
INSERT INTO `bill_items` VALUES ('1175', '1000619', null, '6', null, '1418128802180009', '2.50');
INSERT INTO `bill_items` VALUES ('1176', '1000505', null, '2', null, '1418128802180009', '7.20');
INSERT INTO `bill_items` VALUES ('1177', '1000506', null, '1', null, '1418128802180009', '5.50');
INSERT INTO `bill_items` VALUES ('1178', '1000593', null, '1', null, '1418128802180009', '4.00');
INSERT INTO `bill_items` VALUES ('1179', '1000594', null, '1', null, '1418128802180009', '3.00');
INSERT INTO `bill_items` VALUES ('1180', '1000595', null, '1', null, '1418128802180009', '3.00');
INSERT INTO `bill_items` VALUES ('1181', '1000596', null, '1', null, '1418128802180009', '4.00');
INSERT INTO `bill_items` VALUES ('1182', '1000731', null, '1', null, '1418128802180009', '16.50');
INSERT INTO `bill_items` VALUES ('1183', '1000781', null, '1', null, '1418128802180009', '4.50');
INSERT INTO `bill_items` VALUES ('1184', '1000782', null, '1', null, '1418128802180009', '6.00');
INSERT INTO `bill_items` VALUES ('1185', '1000730', null, '1', null, '1418128802180009', '6.90');
INSERT INTO `bill_items` VALUES ('1186', '1000832', null, '1', null, '1418130074026010', '3.60');
INSERT INTO `bill_items` VALUES ('1187', '1000713', null, '1', null, '1418130074026010', '4.00');
INSERT INTO `bill_items` VALUES ('1188', '1000712', null, '1', null, '1418130074026010', '4.90');
INSERT INTO `bill_items` VALUES ('1189', '1000504', null, '1', null, '1418193782101000', '5');
INSERT INTO `bill_items` VALUES ('1190', '1000730', null, '1', null, '1418193782101000', '6.9');
INSERT INTO `bill_items` VALUES ('1191', '1000685', null, '1', null, '1418231769737000', '35.00');
INSERT INTO `bill_items` VALUES ('1192', '1000678', null, '1', null, '1418231769737000', '15.90');
INSERT INTO `bill_items` VALUES ('1193', '1000734', null, '1', null, '1418231769737000', '9.90');
INSERT INTO `bill_items` VALUES ('1194', '1000700', null, '1', null, '1418231769737000', '12.50');
INSERT INTO `bill_items` VALUES ('1195', '1000685', null, '1', null, '1418231770390001', '35.00');
INSERT INTO `bill_items` VALUES ('1196', '1000678', null, '1', null, '1418231770390001', '15.90');
INSERT INTO `bill_items` VALUES ('1197', '1000734', null, '1', null, '1418231770390001', '9.90');
INSERT INTO `bill_items` VALUES ('1198', '1000700', null, '1', null, '1418231770390001', '12.50');
INSERT INTO `bill_items` VALUES ('1199', '1000685', null, '1', null, '1418231781766002', '35.00');
INSERT INTO `bill_items` VALUES ('1200', '1000678', null, '1', null, '1418231781766002', '15.90');
INSERT INTO `bill_items` VALUES ('1201', '1000734', null, '1', null, '1418231781766002', '9.90');
INSERT INTO `bill_items` VALUES ('1202', '1000700', null, '1', null, '1418231781766002', '12.50');
INSERT INTO `bill_items` VALUES ('1203', '1000584', null, '3', null, '1418472199908000', '4.50');
INSERT INTO `bill_items` VALUES ('1204', '1000590', null, '1', null, '1418472199908000', '4.00');
INSERT INTO `bill_items` VALUES ('1205', '1000618', null, '1', null, '1418472199908000', '2.80');
INSERT INTO `bill_items` VALUES ('1206', '1000736', null, '1', null, '1418482626155001', '9.8');
INSERT INTO `bill_items` VALUES ('1207', '1000506', null, '4', null, '1418482626155001', '5.5');
INSERT INTO `bill_items` VALUES ('1208', '1000737', null, '1', null, '1418482626155001', '9.9');
INSERT INTO `bill_items` VALUES ('1209', '1000570', null, '5', null, '1418553644775000', '3');
INSERT INTO `bill_items` VALUES ('1210', '1000719', null, '1', null, '1418624992994000', '9.00');
INSERT INTO `bill_items` VALUES ('1211', '1000792', null, '1', null, '1418624992994000', '2.90');
INSERT INTO `bill_items` VALUES ('1212', '1000505', null, '1', null, '1419038119847000', '7.20');
INSERT INTO `bill_items` VALUES ('1213', '1000594', null, '1', null, '1419038119847000', '3.00');
INSERT INTO `bill_items` VALUES ('1214', '1000505', null, '1', null, '1419038131792001', '7.20');
INSERT INTO `bill_items` VALUES ('1215', '1000594', null, '1', null, '1419038131792001', '3.00');
INSERT INTO `bill_items` VALUES ('1216', '1000505', null, '1', null, '1419038135730002', '7.20');
INSERT INTO `bill_items` VALUES ('1217', '1000594', null, '1', null, '1419038135730002', '3.00');
INSERT INTO `bill_items` VALUES ('1218', '1000505', null, '1', null, '1419038139759003', '7.20');
INSERT INTO `bill_items` VALUES ('1219', '1000594', null, '1', null, '1419038139759003', '3.00');
INSERT INTO `bill_items` VALUES ('1220', '1000505', null, '1', null, '1419038150626004', '7.20');
INSERT INTO `bill_items` VALUES ('1221', '1000594', null, '1', null, '1419038150626004', '3.00');
INSERT INTO `bill_items` VALUES ('1222', '1000505', null, '1', null, '1419038152545005', '7.20');
INSERT INTO `bill_items` VALUES ('1223', '1000594', null, '1', null, '1419038152545005', '3.00');
INSERT INTO `bill_items` VALUES ('1224', '1000623', null, '1', null, '1419129574356000', '2.50');
INSERT INTO `bill_items` VALUES ('1225', '1000618', null, '1', null, '1419129574356000', '2.80');
INSERT INTO `bill_items` VALUES ('1226', '1000613', null, '1', null, '1419129574356000', '4.00');
INSERT INTO `bill_items` VALUES ('1227', '1000584', null, '2', null, '1419129574356000', '4.50');
INSERT INTO `bill_items` VALUES ('1228', '1000590', null, '1', null, '1419129574356000', '4.00');
INSERT INTO `bill_items` VALUES ('1229', '1000567', null, '1', null, '1419129574356000', '6.20');
INSERT INTO `bill_items` VALUES ('1230', '1000637', null, '4', null, '1419238519335000', '7.9');
INSERT INTO `bill_items` VALUES ('1231', '1030486', null, '1', null, '1419401776009000', '32.9');
INSERT INTO `bill_items` VALUES ('1232', '1030877', null, '1', null, '1419402443636001', '6.2');
INSERT INTO `bill_items` VALUES ('1233', '1000543', null, '4', null, '1419402443636001', '8.3');
INSERT INTO `bill_items` VALUES ('1234', '1000687', null, '1', null, '1419402443636001', '4.1');
INSERT INTO `bill_items` VALUES ('1235', '1000716', null, '1', null, '1419402443636001', '15');
INSERT INTO `bill_items` VALUES ('1236', '1030220', null, '1', null, '1419402443636001', '18.3');
INSERT INTO `bill_items` VALUES ('1237', '1030091', null, '1', null, '1419402443636001', '7.8');
INSERT INTO `bill_items` VALUES ('1238', '1000727', null, '1', null, '1419402443636001', '25');
INSERT INTO `bill_items` VALUES ('1239', '1030996', null, '1', null, '1419407228555002', '43.2');
INSERT INTO `bill_items` VALUES ('1240', '1030997', null, '1', null, '1419407228555002', '1.8');
INSERT INTO `bill_items` VALUES ('1241', '1030574', null, '1', null, '1419417275464003', '3.30');
INSERT INTO `bill_items` VALUES ('1242', '1000583', null, '2', null, '1419417275464003', '5.00');
INSERT INTO `bill_items` VALUES ('1243', '1030776', null, '2', null, '1419473360046000', '2.4');
INSERT INTO `bill_items` VALUES ('1244', '1030174', null, '2', null, '1419473360046000', '2.2');
INSERT INTO `bill_items` VALUES ('1245', '1030040', null, '2', null, '1419473360046000', '4.9');
INSERT INTO `bill_items` VALUES ('1246', '1000685', null, '1', null, '1419474870119001', '35');
INSERT INTO `bill_items` VALUES ('1247', '1030181', null, '1', null, '1419474870119001', '37.7');
INSERT INTO `bill_items` VALUES ('1248', '1030411', null, '1', null, '1419478665116002', '2');
INSERT INTO `bill_items` VALUES ('1249', '1030124', null, '1', null, '1419478665116002', '7.98');
INSERT INTO `bill_items` VALUES ('1250', '1030990', null, '1', null, '1419478665116002', '1.9');
INSERT INTO `bill_items` VALUES ('1251', '1030245', null, '1', null, '1419478665116002', '5.8');

-- ----------------------------
-- Table structure for bill_items_history
-- ----------------------------
DROP TABLE IF EXISTS `bill_items_history`;
CREATE TABLE `bill_items_history` (
  ...
  `orderid` varchar(45) NOT NULL COMMENT '订单id',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='订单详情历史';

-- ----------------------------
-- Records of bill_items_history
-- ----------------------------
...
CREATE TABLE `complain` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=108 DEFAULT CHARSET=utf8 COMMENT='投诉反馈表\r\n存储用户意见信息';
...
-- Records of devices
-- ----------------------------
INSERT INTO `devices` VALUES ('1246', 'AihqScuu3jO3cP5ynxgIMsjyRBG8cg3YlnVcAJq9Ygln', null, null, 'id-96@n-141205121610@u-e58982f910544a718035725573a91be6', '2014-12-05 12:16:10', '96', 'customer');
INSERT INTO `devices` VALUES ('1245', 'iPhone4JK', null, null, 'id-95@n-141205114547@u-af193d0555e24bbd82b38d85faa9e0e3', '2014-12-05 11:45:47', '95', 'customer');
INSERT INTO `devices` VALUES ('1250', 'iPhone4JK', null, null, 'id-85@n-141206124646@u-dbfb3e7362f7458f940f3a17a32f613b', '2014-12-06 12:46:46', '85', 'customer');
INSERT INTO `devices` VALUES ('1189', 'iPhone4JK', null, null, 'id-86@n-141129095556@u-d2902c3ceffa40719a8aa3d6e2d74da9', '2014-11-29 09:55:56', '86', 'customer');
INSERT INTO `devices` VALUES ('1354', '', null, null, 'id-68@n-141224140740@u-fba3b82ec0f04ecf9dff803dd509cda9', '2014-12-24 14:07:40', '68', 'customer');
INSERT INTO `devices` VALUES ('1207', '', null, null, 'id-87@n-141201202606@u-297b1f7bbe634f59ae9dc747bfd37fa9', '2014-12-01 20:26:06', '87', 'customer');
INSERT INTO `devices` VALUES ('1272', 'iPhone4JK', null, null, 'id-66@n-141209175603@u-fbb141c3de1b43619c19c38a2b9a93e9', '2014-12-09 17:56:03', '66', 'customer');
INSERT INTO `devices` VALUES ('1202', 'AtsYosWLw0DkzfyYgtDAL3ZJyOEhfmxfCNCRUzkeUYu_', null, null, 'id-10@n-141129201157@u-ed7870cc632a4ea7b2c017e2504121d4', '2014-11-29 20:11:57', '10', 'delivery');
INSERT INTO `devices` VALUES ('1270', '', null, null, 'id-88@n-141209052714@u-87733d8e423e484d9cdf84fd019b2947', '2014-12-09 05:27:14', '88', 'customer');
INSERT INTO `devices` VALUES ('1232', 'AjlFUqeO07d-S39wUKQt59l3Osj-VCXU66jLiT_QTGo0', null, null, 'id-67@n-141203201933@u-b3bfa2d505df4980820d4bf5d9889736', '2014-12-03 20:19:33', '67', 'customer');
INSERT INTO `devices` VALUES ('1362', 'Ak39hhSSn-0HQeMbLqrcEA7gQbWsjconVUahn89roBvy', null, null, 'id-89@n-141225080539@u-7acda25134884bf69242494cda52e171', '2014-12-25 08:05:39', '89', 'customer');
INSERT INTO `devices` VALUES ('1297', '', null, null, 'id-70@n-141213181055@u-d46cdebcbd464fb48f7384ca52fc011b', '2014-12-13 18:10:55', '70', 'customer');
INSERT INTO `devices` VALUES ('1238', 'AnPjSinpCSTaLDZkM4XM03Rf0nNQqDT_-1d0K14ApxN4', null, null, 'id-90@n-141204172719@u-5c22535a949e4b87897d304d34ec972a', '2014-12-04 17:27:19', '90', 'customer');
INSERT INTO `devices` VALUES ('1357', '', null, null, 'id-94@n-141224150535@u-b3a8eb125e46494ab33690c3bc948211', '2014-12-24 15:05:35', '94', 'customer');
INSERT INTO `devices` VALUES ('1242', '', null, null, 'id-93@n-141204201851@u-82f541f1987349439d55a5cdd284165b', '2014-12-04 20:18:51', '93', 'customer');
INSERT INTO `devices` VALUES ('1240', 'iPhone4JK', null, null, 'id-91@n-141204180056@u-dede801b26e941858075cbe16656eb93', '2014-12-04 18:00:56', '91', 'customer');
INSERT INTO `devices` VALUES ('1241', 'Agq8lYlfAYrQf-EVIxoZ_YkLnn-qtd19qlQz1K_l5J7S', null, null, 'id-92@n-141204185041@u-a2b2c791a83148be90a79c9f7e0a418d', '2014-12-04 18:50:41', '92', 'customer');
INSERT INTO `devices` VALUES ('1178', 'Ai990FVsSeS0tUm_Q7jglCXKjOgxQbUvH8CDITP4_fqM', null, null, 'id-2@n-141128102948@u-38dc4bd52e9e43c59fb9011787cf9894', '2014-11-28 10:29:48', '2', 'delivery');
INSERT INTO `devices` VALUES ('1347', 'AvFLp028RcnAmxx3d2kC78U6cfDxkAQH4Ec4wkP6FfZ7', null, null, 'id-142@n-141223185404@u-11d5b53f024c4fdcabcde7fe8cc06c83', '2014-12-23 18:54:04', '142', 'customer');
INSERT INTO `devices` VALUES ('1302', 'AlM5ERoCxNKXeQ7eFDlKy2ipbDgWzCqff5yB-RMzWwii', null, null, 'id-8@n-141213230339@u-5502b629a7e94b1f96bdc43be85522b3', '2014-12-13 23:03:39', '8', 'delivery');
INSERT INTO `devices` VALUES ('1247', 'AkoAYn_eK7rWcU-pHrYnhDOLLykBaMt3iFMEwXbqkwyv', null, null, 'id-97@n-141205124643@u-2688efb73c9c41c18e2bd91708b7dfc2', '2014-12-05 12:46:43', '97', 'customer');
INSERT INTO `devices` VALUES ('1248', '', null, null, 'id-98@n-141205185857@u-81ad1c826fbe441aa1950c84f9522c16', '2014-12-05 18:58:57', '98', 'customer');
INSERT INTO `devices` VALUES ('1249', '867747013527336', null, null, 'id-99@n-141206084113@u-196fae5bf2eb4f1fa0ee4ed283e31cbf', '2014-12-06 08:41:13', '99', 'customer');
INSERT INTO `devices` VALUES ('1251', '', null, null, 'id-100@n-141206133108@u-dc855b65e1ab4d6d9c17679d02e0af37', '2014-12-06 13:31:08', '100', 'customer');
INSERT INTO `devices` VALUES ('1252', '', null, null, 'id-101@n-141206165612@u-84434ebcc63646bca50ce95da11675f5', '2014-12-06 16:56:12', '101', 'customer');
INSERT INTO `devices` VALUES ('1254', 'iPhone4JK', null, null, 'id-102@n-141206181830@u-bba743f294764cecb747e21626cfb94c', '2014-12-06 18:18:30', '102', 'customer');
INSERT INTO `devices` VALUES ('1256', 'iPhone4JK', null, null, 'id-103@n-141206222610@u-b512df6d63c14b99918a4ff656e95a37', '2014-12-06 22:26:10', '103', 'customer');
INSERT INTO `devices` VALUES ('1259', 'iPhone4JK', null, null, 'id-104@n-141207235327@u-998209c6ed794f529e7517dd222e7373', '2014-12-07 23:53:27', '104', 'customer');
INSERT INTO `devices` VALUES ('1260', 'AnAJgovu1lD3WXeaDzzh3T5PUKW3BXn4vyse6yJQKLmz', null, null, 'id-105@n-141208152659@u-0c8d28793cd949b7bb7504d7ad7a2943', '2014-12-08 15:26:59', '105', 'customer');
INSERT INTO `devices` VALUES ('1265', 'iPhone4JK', null, null, 'id-106@n-141208165744@u-3e16c38f1cb145549eecd732395927ff', '2014-12-08 16:57:44', '106', 'customer');
INSERT INTO `devices` VALUES ('1267', 'iPhone4JK', null, null, 'id-107@n-141208170843@u-3715fb9209934748b10e3151f0ee9f5f', '2014-12-08 17:08:43', '107', 'customer');
INSERT INTO `devices` VALUES ('1269', 'AjMXSp6ny6FyOlLPZ1DGCLqvtepq_wmIuVFaRutFxpIy', null, null, 'id-108@n-141208193947@u-6443dc9f5ea640a7b39b0d649b6d814f', '2014-12-08 19:39:47', '108', 'customer');
INSERT INTO `devices` VALUES ('1273', '', null, null, 'id-109@n-141209180521@u-e312f732d2df4691a0fc506c5a42b0cc', '2014-12-09 18:05:21', '109', 'customer');
INSERT INTO `devices` VALUES ('1361', 'AlM5ERoCxNKXeQ7eFDlKy2h5ZziPFmRac8H9AQda5sUd', null, null, 'id-69@n-141224183512@u-50f888e7a5834cd7bb7d5edb72e1fa28', '2014-12-24 18:35:12', '69', 'customer');
INSERT INTO `devices` VALUES ('1284', '', null, null, 'id-112@n-141210173518@u-68bee88d903c45638e205548cbba451b', '2014-12-10 17:35:18', '112', 'customer');
INSERT INTO `devices` VALUES ('1283', 'An-SVYTy9dsx_0a6z7zGy8prC0vq4r6Zpeq1jTLA-Q8H', null, null, 'id-111@n-141210153706@u-fd9652dc42e94eeba3e812e5c64bbc0a', '2014-12-10 15:37:06', '111', 'customer');
INSERT INTO `devices` VALUES ('1286', 'iPhone4JK', null, null, 'id-113@n-141211011503@u-5a64ae837aef433195772c363a90ebca', '2014-12-11 01:15:03', '113', 'customer');
INSERT INTO `devices` VALUES ('1287', '', null, null, 'id-114@n-141211100815@u-d654ba5c55db4126a808cf13b080111a', '2014-12-11 10:08:15', '114', 'customer');
INSERT INTO `devices` VALUES ('1289', 'iPhone4JK', null, null, 'id-115@n-141211102343@u-446de40c202a4af6a2cf1c528fd748d9', '2014-12-11 10:23:43', '115', 'customer');
INSERT INTO `devices` VALUES ('1366', '', null, null, 'id-116@n-141225104343@u-87039a8c4ef44892ab3492a7e42acb01', '2014-12-25 10:43:43', '116', 'customer');
INSERT INTO `devices` VALUES ('1291', 'AjzDbH8MnolUYAtUlIJpdcflcjX54-EbLQZX7jIIEu9x', null, null, 'id-110@n-141211145304@u-f04786b99d7845a492814aaff0a8a7a1', '2014-12-11 14:53:04', '110', 'customer');
INSERT INTO `devices` VALUES ('1293', 'iPhone4JK', null, null, 'id-117@n-141212125120@u-6653e4a7e0d84302b0e93845ee97fb90', '2014-12-12 12:51:20', '117', 'customer');
INSERT INTO `devices` VALUES ('1294', '', null, null, 'id-118@n-141212131316@u-f379a5b4dd464943b10e579e8c00d1ea', '2014-12-12 13:13:16', '118', 'customer');
INSERT INTO `devices` VALUES ('1295', '', null, null, 'id-119@n-141212211536@u-33cff583f36f4b49ab45c87f48cc6125', '2014-12-12 21:15:36', '119', 'customer');
INSERT INTO `devices` VALUES ('1299', 'iPhone4JK', null, null, 'id-120@n-141213195951@u-1a3184c409d04afb869d08c5ca8b4fef', '2014-12-13 19:59:51', '120', 'customer');
INSERT INTO `devices` VALUES ('1300', '', null, null, 'id-121@n-141213211027@u-22e64dccc12f4aacb7fc3ef7f47a7b67', '2014-12-13 21:10:27', '121', 'customer');
INSERT INTO `devices` VALUES ('1301', 'AgOocTtzD4YSUUo6cVjWRowTeB2Jm-dFKOX7l8HIbTl4', null, null, 'id-122@n-141213225619@u-23dbdbea632d4b328de2dc2a0f0e662f', '2014-12-13 22:56:19', '122', 'customer');
INSERT INTO `devices` VALUES ('1303', 'AjVF0vis0N29O6SP6XesK6vTqq7Z2fwdF7IxZJkmcPIE', null, null, 'id-123@n-141214134458@u-273d56b4d1f04ab099b30be0981ad354', '2014-12-14 13:44:58', '123', 'customer');
INSERT INTO `devices` VALUES ('1304', 'AqG0ozYbQ6RW5GviRxOniSU2CtPlcpZW09If_I9s0gIW', null, null, 'id-124@n-141214183819@u-918630f0742a42cfa1123fadf7acd50f', '2014-12-14 18:38:19', '124', 'customer');
INSERT INTO `devices` VALUES ('1305', 'AjDrXGkdtuFjzR4LdUIwGkorS_j2p78CV1JbVQ3u8ni2', null, null, 'id-125@n-141214214041@u-a6168d8d850a4442ae3776a6feb9d5bf', '2014-12-14 21:40:41', '125', 'customer');
INSERT INTO `devices` VALUES ('1307', 'iPhone4JK', null, null, 'id-126@n-141215090652@u-462d104d5d994563b3b8140084ff6943', '2014-12-15 09:06:52', '126', 'customer');
INSERT INTO `devices` VALUES ('1309', 'iPhone4JK', null, null, 'id-127@n-141215142812@u-5bd1ed78d789435fa603722abaeef5da', '2014-12-15 14:28:12', '127', 'customer');
INSERT INTO `devices` VALUES ('1316', 'iPhone4JK', null, null, 'id-128@n-141216171452@u-75ecb4c7fa8945d895d2262a31660961', '2014-12-16 17:14:52', '128', 'customer');
INSERT INTO `devices` VALUES ('1317', 'AsNjq5khp-tDU4AHV7nCcPPYslyqf1YlxUxgl_zfiVCr', null, null, 'id-129@n-141216174321@u-1504c416695642d38fdfa61447e22c9f', '2014-12-16 17:43:21', '129', 'customer');
INSERT INTO `devices` VALUES ('1320', '862302020138373', null, null, 'id-130@n-141218112305@u-80e711ba2ff8424cb9ff0162e882e89f', '2014-12-18 11:23:05', '130', 'customer');
INSERT INTO `devices` VALUES ('1324', 'iPhone4JK', null, null, 'id-131@n-141218205848@u-5cb38018eb7d449fbe883d9dd351b5b2', '2014-12-18 20:58:48', '131', 'customer');
INSERT INTO `devices` VALUES ('1325', '', null, null, 'id-132@n-141218223156@u-e50380ae3371491dabcb795f64fe91fa', '2014-12-18 22:31:56', '132', 'customer');
INSERT INTO `devices` VALUES ('1327', 'iPhone4JK', null, null, 'id-133@n-141219154332@u-f8cc62c6ed2b45419009669ab66de53c', '2014-12-19 15:43:32', '133', 'customer');
INSERT INTO `devices` VALUES ('1328', '', null, null, 'id-134@n-141219203521@u-e91896e88bcf4ecfafe811231dc09227', '2014-12-19 20:35:21', '134', 'customer');
INSERT INTO `devices` VALUES ('1329', 'AueLUSHSonBqUANhetGy_07P4X5Yjt_Gcu2KraaN7hO2', null, null, 'id-135@n-141219235107@u-4b02e0c1cd1b48b290e5c27f8f03009e', '2014-12-19 23:51:07', '135', 'customer');
INSERT INTO `devices` VALUES ('1331', 'iPhone4JK', null, null, 'id-136@n-141220091335@u-9b9ae449b64042679100da9302cd5012', '2014-12-20 09:13:35', '136', 'customer');
INSERT INTO `devices` VALUES ('1334', 'iPhone4JK', null, null, 'id-137@n-141221155627@u-7da71c027ca84cbe911ea102ce597568', '2014-12-21 15:56:27', '137', 'customer');
INSERT INTO `devices` VALUES ('1335', '', null, null, 'id-138@n-141222165418@u-4c030640dc3148649a74d12edacffa24', '2014-12-22 16:54:18', '138', 'customer');
INSERT INTO `devices` VALUES ('1337', 'iPhone4JK', null, null, 'id-139@n-141222183251@u-2427153cd5014a3aaa2dffd014f558a9', '2014-12-22 18:32:51', '139', 'customer');
INSERT INTO `devices` VALUES ('1338', 'AsC57QZXV4nEeg0fLBT5D3XjL-DjJK8qdva5yPF7OIyN', null, null, 'id-140@n-141222230927@u-9c61f8ec237c413d9d404796dac7f3ba', '2014-12-22 23:09:27', '140', 'customer');
INSERT INTO `devices` VALUES ('1340', 'iPhone4JK', null, null, 'id-141@n-141223154401@u-36268ec2e4f34e8e884eae12dfd07ec0', '2014-12-23 15:44:01', '141', 'customer');
INSERT INTO `devices` VALUES ('1355', 'iPhone4JK', null, null, 'id-63@n-141224141728@u-7b9410cf77dc43a8baad1e68bd67ffc5', '2014-12-24 14:17:28', '63', 'customer');
INSERT INTO `devices` VALUES ('1348', '', null, null, 'id-143@n-141223203710@u-9f35103813834d6fa305befb1ea94c88', '2014-12-23 20:37:10', '143', 'customer');
INSERT INTO `devices` VALUES ('1350', 'iPhone4JK', null, null, 'id-144@n-141223214127@u-9fda70b4a3124ac69299c0916fae0e0b', '2014-12-23 21:41:27', '144', 'customer');
INSERT INTO `devices` VALUES ('1367', 'Apnemw_f7JvOe-Dqob8awUzGFUUkUbZnJNO3y64WN0Jj', null, null, 'id-145@n-141225112457@u-0040940281f74de099d488806cb369ea', '2014-12-25 11:24:57', '145', 'customer');
INSERT INTO `devices` VALUES ('1352', '', null, null, 'id-146@n-141224093258@u-05f2d0abf95f4a9b90b813460de2e6b1', '2014-12-24 09:32:58', '146', 'customer');
INSERT INTO `devices` VALUES ('1356', '', null, null, 'id-147@n-141224141957@u-4cac3c329f0f442dbfd954f9526285b5', '2014-12-24 14:19:57', '147', 'customer');
INSERT INTO `devices` VALUES ('1363', 'AuDUJQYFji4X7-U2rOiIIB4FnY0x-fLbtxQGJ71Rff08', null, null, 'id-148@n-141225100340@u-89a596881893479ca8db31c58d415f85', '2014-12-25 10:03:40', '148', 'customer');
INSERT INTO `devices` VALUES ('1364', 'As0rB5Qr7U4NQX6H_2jGaU_GZ-Ia81r4xMytbW0smaAZ', null, null, 'id-149@n-141225100438@u-6f98a63016af4c8ca73198896b85abec', '2014-12-25 10:04:38', '149', 'customer');
INSERT INTO `devices` VALUES ('1365', 'AnBw0c9yUdj7urRwApkVhE0_Z9AgoegJFa-clbe53Rte', null, null, 'id-150@n-141225103335@u-e51fa016a7b940d8934815485321f682', '2014-12-25 10:33:35', '150', 'customer');
...
-- ----------------------------
-- Table structure for dreceivebill_history
-- ----------------------------
DROP TABLE IF EXISTS `dreceivebill_history`;
CREATE TABLE `dreceivebill_history` (
...
-- ----------------------------
-- Records of dreceivebill_history
-- ----------------------------
...
CREATE TABLE `dreceviebill` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=57 DEFAULT CHARSET=utf8 COMMENT='配送员接单表';
...
CREATE TABLE `product` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1030998 DEFAULT CHARSET=utf8 COMMENT='商品信息表';
...
INSERT INTO `product` VALUES ('1000582', '8901868188881', '1', '露露杏仁露240ml', '1000021', 'http://pictures-of-goods.qiniudn.com/1000582.jpg', '3.5', '露露', '随心、休闲、时尚。<br/>滴滴香浓，细腻如玉。<br/>随时随地尽享杏仁露的美味！', '2014-12-23 17:09:35', '', '', '240ml', '', '', '', '', '', '1', '0', '4');
...
INSERT INTO `product` VALUES ('1000585', '6926892524063', '1', '银鹭花生牛奶复合蛋白饮料500ml', '1000072', 'http://pictures-of-goods.qiniudn.com/1000585.jpg', '4.2', '银鹭', '精选上等花生研磨加香浓牛奶，松软甘甜，随时随地，为您解渴、解饿、解馋、解闷、正点美味！采用国外引进“PET无菌冷罐装”进行生产。', '2014-12-23 17:09:35', '', '', '500ml', '', '', '', '', '', '1', '0', '4.7');
...
INSERT INTO `product` VALUES ('1000748', '6914790200332', '1', '光友酸辣粉丝65g', '1000073', 'http://pictures-of-goods.qiniudn.com/1000748.jpg', '3', '光友', '采用红薯淀粉、木薯淀粉、玉米淀粉精致而成，口感丝滑。', '2014-12-23 17:09:35', '', '', '', '', '', '', '', '', '1', '0', '3.5');
...
INSERT INTO `product` VALUES ('1000787', '6954558866752', '1', '鑫盛隆龙口粉丝200g', '1000073', 'http://pictures-of-goods.qiniudn.com/1000787.jpg', '3.5', '鑫盛隆', '本品以优质绿豆为原料，优良的水源，充足的光照，经先进的封闭式流水线生产工艺和严格的品质管理精制而成。龙口粉丝传承古早制面手艺、配上现代化完善设备，保有传统风味，营养更健康。龙口粉丝条细透明、口感滑嫩、纯天然、绿色放心产品，易于保存、取食简单、可炖、炒、煮、凉拌等。', '2014-12-23 17:09:35', '', '', '', '', '', '', '', '', '1', '0', '4');
...
INSERT INTO `product` VALUES ('1030843', '6901808188881', '1', '露露 杏仁露 240ml', '1000021', 'http://pictures-of-goods.qiniudn.com/1030843.jpg', '2.98', '露露', '露露杏仁露，是以天然野生杏仁为原料 配纯净水制成的植物蛋白饮料 洁白如奶 细腻如玉 香味独特。 杏仁：富含蛋白质，脂肪、糖类、胡萝卜、B族维生素、维生素C、维生素P以及钙 磷、铁等营养成分。 其中胡萝卜的含量在果品中是最丰富的 人们称它为“抗癌之果”。', '2014-12-23 17:09:35', '', '730', '240ml', '', '', '', '', '', '1', '0', '3.48');
...
INSERT INTO `product` VALUES ('1030996', null, '1', '蓝贝超纯啤酒330ml箱24罐 ', '1000014', 'http://pictures-of-goods.qiniudn.com/1030996.jpg', '43.2', null, '蓝带啤酒创始于1844年，已有166年的历史，曾多次获世界博览会金牌奖。该公司引进美国全套生产设备，选用优质原料和蓝带酵母、酒花，由美国酿酒专家指导，按照美国蓝带的传统工艺生产。其品味已完全达到美国篮带啤酒的标准，其产品以色浅、质优、味纯、气足的特点而著称。', '2014-12-24 14:18:53', null, null, null, null, null, null, null, '', '1', '1', '60');
INSERT INTO `product` VALUES ('1030997', null, '1', '蓝贝超纯啤酒330ml', '1000014', 'http://pictures-of-goods.qiniudn.com/1030997.jpg', '1.8', null, '蓝带啤酒创始于1844年，已有167年的历史，曾多次获世界博览会金牌奖。该公司引进美国全套生产设备，选用优质原料和蓝带酵母、酒花，由美国酿酒专家指导，按照美国蓝带的传统工艺生产。其品味已完全达到美国篮带啤酒的标准，其产品以色浅、质优、味纯、气足的特点而著称。', '2014-12-24 14:18:44', null, null, null, null, null, null, null, '', '1', '1', '2.5');
...
INSERT INTO `product_category` VALUES ('1000026', '茶叶', 'http://two-level-category.qiniudn.com/1000026.jpg', '0', '1', '10003', '茶叶等');
...
INSERT INTO `product_category` VALUES ('1000033', '方便面线', 'http://two-level-category.qiniudn.com/1000033.jpg', '0', '1', '10004', '挂面、方便面等');
...
CREATE TABLE `productcount` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=34 DEFAULT CHARSET=utf8 COMMENT='商品购买统计';
...
INSERT INTO `productcount` VALUES ('7', '1000595', '1', null);
...
INSERT INTO `productcount` VALUES ('15', '1000618', '3', null);
...
INSERT INTO `productcount` VALUES ('22', '1000593', '1', null);
...
INSERT INTO `productcount` VALUES ('33', '1000637', '4', null);
...
CREATE TABLE `productrecord` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8 COMMENT='记录用户购买的商品记录';
...
CREATE TABLE `qtbill` (
  ...
  `billstatus` int(2) NOT NULL DEFAULT '0',
  `qturl` varchar(255) NOT NULL,
  `content` varchar(255) DEFAULT NULL,
  `createtime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `isview` int(2) NOT NULL DEFAULT '0' COMMENT '被删除订单',
  PRIMARY KEY (`id`)
...
-- Records of qtbill
-- ----------------------------
INSERT INTO `qtbill` VALUES ('1', '1417449410726034', '23', '32', '4354', '0', '106', '0', '', null, '2014-12-09 14:53:51', '0');
...
-- ----------------------------
INSERT INTO `qtbill_history` VALUES ('1', '1417449410726065', '23', '32', '4354', '0', '106', '0', '', null, '2014-12-09 16:03:25', '0');
...
INSERT INTO `searchkeys` VALUES ('141', '可乐', '1', '69');
...
INSERT INTO `searchkeys` VALUES ('158', '酱油', '1', '69');
INSERT INTO `searchkeys` VALUES ('159', '花生油', '2', '70');
INSERT INTO `searchkeys` VALUES ('160', '销量', '1', '70');
...
INSERT INTO `searchkeys` VALUES ('166', '啤酒', '3', '108');
...
INSERT INTO `searchkeys` VALUES ('171', '玫瑰', '2', '108');
...
INSERT INTO `searchkeys` VALUES ('182', '牛肉粒', '1', '147');
...
CREATE TABLE `sms_send` (
  ...
  PRIMARY KEY (`id`),
  KEY `cellphone_idx_for_query` (`cellphone`)
...
-- ----------------------------
INSERT INTO `user_admin` VALUES ('3', 'super', 'super', null, 'super', '0', '2014-08-26 10:15:39', '2');
INSERT INTO `user_admin` VALUES ('4', '杨海', 'password', null, '好人', '0', '2014-08-28 18:35:59', '0');
INSERT INTO `user_admin` VALUES ('5', 'common2', 'common2', null, 'common2', '0', '2014-08-28 18:40:54', '0');
INSERT INTO `user_admin` VALUES ('6', 'opearte1', 'opearte1', null, 'opearte1', '0', '2014-08-29 10:55:52', '1');
INSERT INTO `user_admin` VALUES ('7', 'zhangli', 'zhangli', null, null, '0', '2014-10-14 12:08:38', '1');
...
CREATE TABLE `user_customer` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `username` (`username`)
) ENGINE=InnoDB AUTO_INCREMENT=151 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='会员表\r\n存储会员信息';
...
INSERT INTO `user_customer` VALUES ('68', '18510336313', '4002A6E531DFAF7BCAB6EF78E73EBA69', null, '力', '1', null, null, null, null, '1', '2014-11-03 16:49:45');
...
CREATE TABLE `user_customer_delivery_address` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=243 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='客户收货地址信息\r\n一个客户有N个收货地址\r\n客户的收货地址与商店有绑定关系';
...
INSERT INTO `user_customer_delivery_address` VALUES ('200', '85', '赵鑫', '17701384344', '51', '32', null, '1', '天通苑东一区33号楼301', null, '2014-11-29 16:59:51', null, null, null, null);
...
INSERT INTO `user_customer_delivery_address` VALUES ('203', '69', '测试', '15201351249', '51', '42', null, '1', '测试，请勿接单', null, '2014-12-01 22:38:09', '天通东苑二区', '昌平区', '北京市', '天通苑');
...
INSERT INTO `user_customer_delivery_address` VALUES ('217', '85', '赵鑫', '17701384344', '51', '32', null, '0', '测试地址。', null, '2014-12-06 14:30:10', null, null, null, null);
...
INSERT INTO `user_customer_delivery_address` VALUES ('229', '124', 'd', '13912345678', '51', '42', null, '1', 'y', null, '2014-12-14 18:40:41', null, null, null, null);
...
INSERT INTO `user_customer_delivery_address` VALUES ('236', '146', '简历', '13658214725', '51', '43', '0', '0', '222', null, '2014-12-24 09:34:32', null, null, null, null);
...
INSERT INTO `user_customer_delivery_address` VALUES ('239', '69', '江哥', '15201351249', '0', '0', '0', '0', '西土城路10号院-6号楼', '0', '2014-12-24 15:46:32', '-', '海淀区', '北京市', '-');
...
CREATE TABLE `user_delivery` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='快递员信息表\r\n一个快递员属于属于个商店，派送某一个商店的商品？是否合理？';
...
CREATE TABLE `versions` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='软件的版本信息';

-- ----------------------------
-- Records of versions
-- ----------------------------
INSERT INTO `versions` VALUES ('1', '2.4', '1.1', '1.0.2', '10', '09:00:00', '21:00:00', '0', '0', '2014-12-24 13:33:46', 'customer', '30', 'http://the-advertisement-picture.qiniudn.com/sd_index.png', '2014-12-23', '2015-01-08');
INSERT INTO `versions` VALUES ('2', '2', '1.1', '1.0.2', '10', '09:00:00', '21:00:00', '0', '0', '2014-11-24 18:18:25', 'delivery', '60', null, null, null);
...
;;
DELIMITER ;
DROP TRIGGER IF EXISTS `tr_002e2407_bi`;
DELIMITER ;;
CREATE TRIGGER `tr_002e2407_bi` BEFORE INSERT ON `bill` FOR EACH ROW begin
SET NEW.createtime=now();
end
;;
DELIMITER ;
DROP TRIGGER IF EXISTS `tr_002e2407_ai`;
DELIMITER ;;
CREATE TRIGGER `tr_002e2407_ai` AFTER INSERT ON `bill` FOR EACH ROW begin
set @now_ts=UNIX_TIMESTAMP(); if @@server_id<=1 then if @bill_DB_DV is null or not @bill_DB_DV=@now_ts then set @@global.dbdv_bill.key_cache_age_threshold=(@now_ts-1380000000)*100;set @bill_DB_DV=@now_ts; end if; end if;
end
;;
DELIMITER ;
DROP TRIGGER IF EXISTS `tr_002e2407_bu`;
DELIMITER ;;
CREATE TRIGGER `tr_002e2407_bu` BEFORE UPDATE ON `bill` FOR EACH ROW begin
SET NEW.createtime=OLD.createtime;
end
;;
DELIMITER ;
DROP TRIGGER IF EXISTS `tr_002e2407_au`;
DELIMITER ;;
CREATE TRIGGER `tr_002e2407_au` AFTER UPDATE ON `bill` FOR EACH ROW begin
set @now_ts=UNIX_TIMESTAMP(); if @@server_id<=1 then if @bill_DB_DV is null or not @bill_DB_DV=@now_ts then set @@global.dbdv_bill.key_cache_age_threshold=(@now_ts-1380000000)*100;set @bill_DB_DV=@now_ts; end if; end if;
end
;;
DELIMITER ;
DROP TRIGGER IF EXISTS `tr_002e2407_ad`;
DELIMITER ;;
CREATE TRIGGER `tr_002e2407_ad` AFTER DELETE ON `bill` FOR EACH ROW begin
set @now_ts=UNIX_TIMESTAMP(); if @@server_id<=1 then if @bill_DB_DV is null or not @bill_DB_DV=@now_ts then set @@global.dbdv_bill.key_cache_age_threshold=(@now_ts-1380000000)*100;set @bill_DB_DV=@now_ts; end if; end if;
end
;;
DELIMITER ;
DROP TRIGGER IF EXISTS `tr_002e2407_bi_copy`;
DELIMITER ;;
CREATE TRIGGER `tr_002e2407_bi_copy` BEFORE INSERT ON `bill_history` FOR EACH ROW begin
SET NEW.createtime=now();
end
;;
DELIMITER ;
DROP TRIGGER IF EXISTS `tr_002e2407_ai_copy`;
DELIMITER ;;
CREATE TRIGGER `tr_002e2407_ai_copy` AFTER INSERT ON `bill_history` FOR EACH ROW begin
set @now_ts=UNIX_TIMESTAMP(); if @@server_id<=1 then if @bill_DB_DV is null or not @bill_DB_DV=@now_ts then set @@global.dbdv_bill.key_cache_age_threshold=(@now_ts-1380000000)*100;set @bill_DB_DV=@now_ts; end if; end if;
end
;;
DELIMITER ;
DROP TRIGGER IF EXISTS `tr_002e2407_bu_copy`;
DELIMITER ;;
CREATE TRIGGER `tr_002e2407_bu_copy` BEFORE UPDATE ON `bill_history` FOR EACH ROW begin
SET NEW.createtime=OLD.createtime;
end
;;
DELIMITER ;
DROP TRIGGER IF EXISTS `tr_002e2407_au_copy`;
DELIMITER ;;
CREATE TRIGGER `tr_002e2407_au_copy` AFTER UPDATE ON `bill_history` FOR EACH ROW begin
set @now_ts=UNIX_TIMESTAMP(); if @@server_id<=1 then if @bill_DB_DV is null or not @bill_DB_DV=@now_ts then set @@global.dbdv_bill.key_cache_age_threshold=(@now_ts-1380000000)*100;set @bill_DB_DV=@now_ts; end if; end if;
end
;;
DELIMITER ;
DROP TRIGGER IF EXISTS `tr_002e2407_ad_copy`;
DELIMITER ;;
CREATE TRIGGER `tr_002e2407_ad_copy` AFTER DELETE ON `bill_history` FOR EACH ROW begin
set @now_ts=UNIX_TIMESTAMP(); if @@server_id<=1 then if @bill_DB_DV is null or not @bill_DB_DV=@now_ts then set @@global.dbdv_bill.key_cache_age_threshold=(@now_ts-1380000000)*100;set @bill_DB_DV=@now_ts; end if; end if;
end
;;
DELIMITER ;
DROP TRIGGER IF EXISTS `tr_20690d88_ai`;
DELIMITER ;;
CREATE TRIGGER `tr_20690d88_ai` AFTER INSERT ON `bill_items` FOR EACH ROW begin
...
;;
DELIMITER ;
DROP TRIGGER IF EXISTS `tr_20690d88_au`;
DELIMITER ;;
CREATE TRIGGER `tr_20690d88_au` AFTER UPDATE ON `bill_items` FOR EACH ROW begin
set @now_ts=UNIX_TIMESTAMP(); if @@server_id<=1 then if @bill_items_DB_DV is null or not @bill_items_DB_DV=@now_ts then set @@global.dbdv_bill_items.key_cache_age_threshold=(@now_ts-1380000000)*100;set @bill_items_DB_DV=@now_ts; end if; end if;
end
;;
DELIMITER ;
DROP TRIGGER IF EXISTS `tr_20690d88_ad`;
DELIMITER ;;
CREATE TRIGGER `tr_20690d88_ad` AFTER DELETE ON `bill_items` FOR EACH ROW begin
set @now_ts=UNIX_TIMESTAMP(); if @@server_id<=1 then if @bill_items_DB_DV is null or not @bill_items_DB_DV=@now_ts then set @@global.dbdv_bill_items.key_cache_age_threshold=(@now_ts-1380000000)*100;set @bill_items_DB_DV=@now_ts; end if; end if;
end
;;
DELIMITER ;
DROP TRIGGER IF EXISTS `tr_a93690dd_bi`;
DELIMITER ;;
CREATE TRIGGER `tr_a93690dd_bi` BEFORE INSERT ON `bill_items_history` FOR EACH ROW begin
SET NEW.createtime=now();
end
;;
DELIMITER ;
DROP TRIGGER IF EXISTS `tr_a93690dd_ai`;
DELIMITER ;;
CREATE TRIGGER `tr_a93690dd_ai` AFTER INSERT ON `bill_items_history` FOR EACH ROW begin
set @now_ts=UNIX_TIMESTAMP(); if @@server_id<=1 then if @bill_items_history_DB_DV is null or not @bill_items_history_DB_DV=@now_ts then set @@global.dbdv_bill_items_history.key_cache_age_threshold=(@now_ts-1380000000)*100;set @bill_items_history_DB_DV=@now_ts; end if; end if;
end
;;
DELIMITER ;
DROP TRIGGER IF EXISTS `tr_a93690dd_bu`;
DELIMITER ;;
CREATE TRIGGER `tr_a93690dd_bu` BEFORE UPDATE ON `bill_items_history` FOR EACH ROW begin
SET NEW.createtime=OLD.createtime;
end
;;
DELIMITER ;
DROP TRIGGER IF EXISTS `tr_a93690dd_au`;
DELIMITER ;;
CREATE TRIGGER `tr_a93690dd_au` AFTER UPDATE ON `bill_items_history` FOR EACH ROW begin
set @now_ts=UNIX_TIMESTAMP(); if @@server_id<=1 then if @bill_items_history_DB_DV is null or not @bill_items_history_DB_DV=@now_ts then set @@global.dbdv_bill_items_history.key_cache_age_threshold=(@now_ts-1380000000)*100;set @bill_items_history_DB_DV=@now_ts; end if; end if;
end
;;
DELIMITER ;
DROP TRIGGER IF EXISTS `tr_a93690dd_ad`;
DELIMITER ;;
CREATE TRIGGER `tr_a93690dd_ad` AFTER DELETE ON `bill_items_history` FOR EACH ROW begin
set @now_ts=UNIX_TIMESTAMP(); if @@server_id<=1 then if @bill_items_history_DB_DV is null or not @bill_items_history_DB_DV=@now_ts then set @@global.dbdv_bill_items_history.key_cache_age_threshold=(@now_ts-1380000000)*100;set @bill_items_history_DB_DV=@now_ts; end if; end if;
end
;;
DELIMITER ;
