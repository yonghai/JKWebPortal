 ...
 *	参数已进行验证
 */
public class DeliveryUserChangePsw extends HttpServlet {
	...
	public void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		try {
			...
			MyLog.newInstance().writeLog(OperateType.DUPDATEPASSWORD, FileType.DUSERINFO, token, "success");
		} catch (NullException e) {
			returninfo = "{\"success\":false,\"token\":\""+token+"\",\"emsg\":\""+validator.getName()+"不能为null\"}";
			MyLog.newInstance().writeLog(OperateType.DUPDATEPASSWORD, FileType.DUSERINFO, token, "fail");
