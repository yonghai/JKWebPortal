...
public class Order {
	...
	private int delivery_address_id; /* 送货地址 */
	private int delivery_address_stamp;/* 配送地址版本 */
	...
	public void setDelivery_address_id(int deliveryAddressId) {
		delivery_address_id = deliveryAddressId;
	}

	public int getDelivery_address_stamp() {
		return delivery_address_stamp;
	}

	public void setDelivery_address_stamp(int deliveryAddressStamp) {
