...
public class SubmitOrder extends HttpServlet{
	...
	public void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		//	order.setBill_status(Integer.parseInt(validator.isNull(req.getParameter("billStatus"), "billStatus")));
			...
			order.setDelivery_address_id(Integer.parseInt(validator.isNull(req.getParameter("address_id"), "address_id")));
		...
		//	order.setDelivery_id(Long.parseLong(validator.isNull(req.getParameter("delivery_id"), "delivery_id")));
			...
			order.setTel(TelValidator.isMobile(validator.isNull(req.getParameter("tel"), "tel")));
			...
			try {
				...
				if(obj.getBoolean("success")){
					...
					try {//15201351249
						 m.sendMsg("17710171716",order.getOrderid());
					} catch (Exception e) {
						e.printStackTrace();
					}
