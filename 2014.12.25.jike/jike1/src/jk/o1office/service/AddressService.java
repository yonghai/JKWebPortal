...
public interface AddressService {
	...
	String saveNewAddress(CustomerAddress ca, String token) throws Exception;

	String updateNewAddress(CustomerAddress ca, String token) throws Exception;

	String getMyAddressList(String token) throws Exception;
