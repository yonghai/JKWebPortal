...
public class Test {
	...
	/*	try {
		...
		File file = new File("C:\\Users\\jike\\Desktop\\jike\\p\\上线商品图片");
		File[] files = file.listFiles();
		for(File f : files){
			String   filename=f.getAbsolutePath();     
			System.out.println(filename.substring(0, filename.lastIndexOf("."))+".jpg");
			boolean b = f.renameTo(new File(filename.substring(0, filename.lastIndexOf("."))+".jpg"));
			if(b)
