...
public class ProductDaoImpl implements ProductDao {
	...
	public List getProductIDAndUserID(String orderid) {
		List list = hibernateTemplate.getSessionFactory()
		.getCurrentSession()
		.createSQLQuery("select b.product_id, a.customerid from bill b,allorder a where b.orderid='"+orderid+"' and a.orderid='"+orderid+"'")
		.list();
		return list;
	}
	...
	public List getProductIDAndProductNum(String orderid) {
		List list = hibernateTemplate.getSessionFactory()
	 	.getCurrentSession()
		.createSQLQuery("select bi.product_id,bi.product_number from bill bi where bi.orderid='"+orderid+"'")
		.list();
		return list;
	}
