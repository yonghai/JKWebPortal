...
public class CourierTradeCompleted extends HttpServlet {
	...
	public void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		try {
			...
			int goodsnum = Integer.parseInt(validator.isNumber(req.getParameter("goodsnum")));
			String goodsprice = validator.isNull(req.getParameter("goodsprice"), "goodsprice");
			returninfo = billHandlerService.billCompleted(orderid,code,token,goodsnum,goodsprice);
