 ...
 * 交易失败
 */
public class CourierTradeFailure extends HttpServlet {
	...
	public void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		try {
			...
			String reason = validator.isNull(req.getParameter("reason"), "reason");
			String orderid = validator.isNull(req.getParameter("orderid"), "orderid");
			returninfo = billHandlerService.billFature(orderid,reason,token);
