...
public interface BillHandlerService {
	...
	String billCompleted(String orderid, String code, String token, int goodsnum, String goodsprice) throws Exception;
	...
	String QTbillCompleted(String orderid, String token) throws Exception;

	String cancelQTBill(String orderid, String reason, String token) throws Exception;

	String QTbillFature(String orderid, String reason, String token) throws Exception;

	String QTbillCompleted(String orderid, String code, String token)throws Exception;
