...
<body class="easyui-layout">
		...
		<div data-options="region:'north'" style="height:30px;overflow: hidden;
			...
			<a href="/jike/adminLogout" id="loginOut">安全退出</a>
			</span>
		...
		<div data-options="region:'west',split:true" title="导航菜单" style="width:180px;">
			<div class="easyui-accordion" fit="true" border="false">
				...
				<div title="商家管理" icon="icon-sys" data-options="iconCls:'icon-news'" style="overflow: auto;">
					<ul>
						<li>
							<div>
								<a target="mainFrame" href="addshops.jsp"> <span
									class="icon icon-add"></span>商家录入</a>
							</div>
						</li>
						<li>
							<div>
								<a target="mainFrame" href="shopslist.jsp"> <span
									class="icon icon-nav"></span>商家列表</a>
							</div>
						</li>
					</ul>
				</div>
				<div title="商品管理" icon="icon-sys" data-options="iconCls:'icon-news',selected:true" style="overflow: auto;">
					<ul>
						<li>
							<div>
								<a target="mainFrame" href="addtype1.jsp"> <span
									class="icon icon-add"></span>添加一级分类</a>
							</div>
						</li>
						<li>
							<div>
								<a target="mainFrame" href="addtype2.jsp"> <span
									class="icon icon-add"></span>添加二级分类</a>
							</div>
						</li>
						<li>
							<div>
								<a target="mainFrame" href="edittype.jsp"> <span
									class="icon icon-nav"></span>分类编辑</a>
							</div>
						</li>
						<li>
							<div>
								<a target="mainFrame" href="addgoods.jsp"> <span
									class="icon icon-nav"></span>商品录入</a>
							</div>
						</li>
						<li>
							<div>
								<a target="mainFrame" href="productlist.jsp"> <span
									class="icon icon-nav"></span>商品列表</a>
							</div>
						</li>
						<li>
							<div>
								<a target="mainFrame" href="promotiongoods.jsp"> <span
									class="icon icon-nav"></span>促销设置</a>
							</div>
						</li>
					</ul>
				</div>
				<div title="小区管理" icon="icon-sys" data-options="iconCls:'icon-news'" style="overflow: auto;">
					<ul>
						<li>
							<div>
								<a target="mainFrame" href="addcommunity.jsp"> <span
									class="icon icon-nav"></span>小区录入</a>
							</div>
						</li>
						<li>
							<div>
								<a target="mainFrame" href="communitylist.jsp"> <span
									class="icon icon-nav"></span>小区列表</a>
							</div>
						</li>
						<li>
							<div>
								<a target="mainFrame" href="addarea.jsp"> <span
									class="icon icon-nav"></span>添加区域</a>
							</div>
						</li>
						<li>
							<div>
								<a target="mainFrame" href="editarea.jsp"> <span
									class="icon icon-nav"></span>区域编辑</a>
							</div>
						</li>
					</ul>
				</div>
				<div title="操作日志" icon="icon-sys" data-options="iconCls:'icon-news'" style="overflow: auto;">
					<ul>
						<li>
							<div>
								<a target="mainFrame" href="operateadminlog.jsp"> <span
