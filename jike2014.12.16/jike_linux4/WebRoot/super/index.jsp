			...
			<div class="easyui-accordion" fit="true" border="false">
				...
				<div title="用户管理" icon="icon-sys" data-options="iconCls:'icon-news'" style="overflow: auto;">
					<ul>
						<li>
							<div>
								<a target="mainFrame" href="commonuser.jsp"> <span
									class="icon icon-nav"></span>普通用户</a>
							</div>
						</li>
						<li>
							<div>
						...
						<li>
							<div>
								<a target="mainFrame" href="commonadmin.jsp"> <span
									class="icon icon-nav"></span>普通管理员</a>
							</div>
						</li>
						<li>
							<div>
								<a target="mainFrame" href="opearteadmin.jsp"> <span
									class="icon icon-nav"></span>操作管理员</a>
							</div>
						</li>
					</ul>
				</div>
				<div title="意见查看" icon="icon-sys" data-options="iconCls:'icon-news',selected:true" style="overflow: auto;">
					<ul>
						<li>
							<div>
								<a target="mainFrame" href="complain.jsp"> <span
									class="icon icon-add"></span>资金对账</a>
							</div>
						</li>
					</ul>
				</div>
				<div title="统计分析" icon="icon-sys" data-options="iconCls:'icon-news',selected:true" style="overflow: auto;">
					<ul>
						<li>
							<div>
						...
						<li>
							<div>
								<a target="mainFrame" href="ordercount.jsp"> <span
									class="icon icon-add"></span>订单统计</a>
							</div>
						</li>
						<li>
							<div>
								<a target="mainFrame" href="usercount.jsp"> <span
									class="icon icon-add"></span>用户统计</a>
							</div>
						</li>
						<li>
							<div>
								<a target="mainFrame" href="goodscount.jsp"> <span
									class="icon icon-add"></span>商品统计</a>
							</div>
						</li>
						<li>
							<div>
								<a target="mainFrame" href="addtype2.jsp"> <span
									class="icon icon-add"></span>用户行为统计</a>
							</div>
						</li>
					</ul>
				</div>
						...
						<li>
							<div>
								<a target="mainFrame" href="http://www.baidu.com"> <span
									class="icon icon-nav"></span>超级管理员</a>
							</div>
							<div>
								<a target="mainFrame" href="http://www.baidu.com"> <span
									class="icon icon-nav"></span>操作管理员</a>
