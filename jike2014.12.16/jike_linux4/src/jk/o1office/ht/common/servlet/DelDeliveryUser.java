...
public class DelDeliveryUser extends HttpServlet{
	private Logger logger = Logger.getLogger("jk.o1office.ht.common.servlet.DelDeliveryUser");
	...
	public void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		try {
			returninfo = userService.delUser(id);
		} catch (Exception e) {
			returninfo = "删除失败";
