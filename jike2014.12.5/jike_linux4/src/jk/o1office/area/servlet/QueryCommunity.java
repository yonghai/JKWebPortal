package jk.o1office.area.servlet;
 ...
 *	参数已验证
 */
public class QueryCommunity extends HttpServlet{
	private Logger logger = Logger.getLogger("jk.o1office.area.servlet.QueryCommunity");
	...
	public void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		try {
			...
			int areaid = Integer.parseInt(validator.isNull(req.getParameter("area_id"), "area_id"));
			returninfo = areaService.getCommunity(areaid,token);
			...
			returninfo = "{\"success\":false,\"token\":\""+token+"\",\"emsg\":\"查询小区出错了\"}";
			e.printStackTrace();
			e.printStackTrace(ExceptionInfo.out());
			ExceptionInfo.out().flush();
		} finally{
