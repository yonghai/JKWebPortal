...
public class DelOrder extends HttpServlet{
	private Logger logger = Logger.getLogger("jk.o1office.ht.common.servlet.DelOrder");
	...
	public void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		int status = Integer.parseInt(req.getParameter("billstatus"));
		try {
			returninfo = orderService.delOrder(id,status);
		} catch (Exception e) {
			returninfo = "删除出错了";
